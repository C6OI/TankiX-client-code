...
namespace Tanks.Lobby.ClientBattleSelect.Impl {
    public class BattleInfoEntranceSystem : ECSSystem {
        ...
        [OnEventFire]
        public void EnterBattle(ButtonClickEvent e, BattleEnterButtonNode button, [JoinAll] SelectedBattleNode battle,
            [JoinAll] ScreenNode screen) {
            ScheduleEvent(new EnterBattleRequestEvent(button.enterBattleButton.TeamColor), battle);
            ScheduleEvent<EnterBattleAttemptEvent>(battle);
            LockAllButtons(screen.battleSelectScreen);
        }

        [OnEventFire]
        public void EnterBattleAsSpectator(ButtonClickEvent e, BattleEnterButtonAsSpectatorNode button,
            [JoinAll] SelectedBattleNode battle, [JoinAll] ScreenNode screen) {
        ...
        [OnEventFire]
        public void EnableSpectatorButton(NodeAddedEvent e, SelectedNotArchivedBattleNode battle,
            [JoinAll] ScreenNode screen) {
        ...
        public void ShowDMButton(NodeAddedEvent e, SelectedNotArchivedDMNode battle, [JoinAll] ScreenNode screen) {
            ...
            LinkSpectatorButtonForNavigation(
                screen.battleSelectScreen.EnterBattleAsSpectatorButton.GetComponent<Selectable>(),
                enterBattleDMButton.GetComponent<Selectable>(),
                enterBattleDMButton.GetComponent<Selectable>());
        }
        ...
        public void ShowTeamButtons(NodeAddedEvent e, SelectedNotArchivedTeamNode battle, [JoinAll] ScreenNode screen) {
            ...
            LinkSpectatorButtonForNavigation(
                screen.battleSelectScreen.EnterBattleAsSpectatorButton.GetComponent<Selectable>(),
                screen.battleSelectScreen.EnterBattleRedButton.GetComponent<Selectable>(),
                screen.battleSelectScreen.EnterBattleBlueButton.GetComponent<Selectable>());
        }
        ...
        [OnEventFire]
        public void InitTeamButtonLock(NodeAddedEvent e, [Combine] TeamNode team, [JoinByBattle] [Context] BattleNode battle,
            [JoinByBattle] ScreenNode screen) => GetTeamButton(team, screen)
            .SetInteractable(!team.Entity.HasComponent<FullTeamComponent>() && CanEnter(battle));
        ...
        [OnEventFire]
        public void UnlockTeamButton(NodeRemoveEvent e, [Combine] FullTeamNode team,
            [Context] [JoinByBattle] BattleNode battle, [JoinByBattle] ScreenNode screen) =>
            GetTeamButton(team, screen).SetInteractable(CanEnter(battle));

        static GameObject GetTeamButton(TeamNode team, ScreenNode screen) {
        ...
        void LinkSpectatorButtonForNavigation(Selectable spectatorButton, Selectable up, Selectable down) {
        ...
        void LockAllButtons(BattleSelectScreenComponent screenComponent) {
        ...
        void HideAllButtons(BattleSelectScreenComponent screenComponent) {
        ...
        bool CanEnter(BattleNode battle) => battle.personalBattleInfo.Info.CanEnter;
