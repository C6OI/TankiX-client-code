...
namespace Tanks.Lobby.ClientPaymentGUI.Impl {
    public class SelectCountryFilter : MonoBehaviour {
        ...
        void OnEnable() => inputField.onValueChanged.AddListener(ApplyFilter);

        void OnDisable() => inputField.onValueChanged.RemoveListener(ApplyFilter);

        void ApplyFilter(string arg0) => list.ApplyFilter(IsFiltered);
