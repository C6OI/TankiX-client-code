...
namespace Tanks.Lobby.ClientHangar.Impl {
    public class HangarCameraControlSystem : ECSSystem {
        ...
        [OnEventFire]
        public void MouseRotateBegin(EventSystemOnBeginDragEvent e, ScreenForegroundNode screenForeground,
            [JoinAll] HangarCameraTankViewNonDragNode hangar) => hangar.Entity.AddComponent<HangarCameraDragComponent>();

        [OnEventFire]
        public void MouseRotateBegin(EventSystemOnBeginDragEvent e, ScreenForegroundNode screenForeground,
            [JoinAll] HangarCameraTankViewIdleNode hangar) =>
            hangar.Entity.AddComponent<HangarCameraDecelerationRotateComponent>();

        [OnEventFire]
        public void MouseRotate(EventSystemOnDragEvent e, ScreenForegroundNode screenForeground,
            [JoinAll] HangarCameraTankViewRotateNode hangar) {
        ...
        [OnEventFire]
        public void MouseRotateEnd(EventSystemOnEndDragEvent e, ScreenForegroundNode screenForeground,
            [JoinAll] HangarCameraTankViewRotateNode hangar) {
        ...
        public void DecelerationRotate(UpdateEvent e, HangarCameraTankViewDecelerationRotateNode hangar) {
            hangar.hangarCameraDecelerationRotate.Speed *=
                Mathf.Exp((0f - hangar.hangarConfig.DecelerationRotateFactor) * Time.deltaTime);
        ...
        [OnEventFire]
        public void StopDecelerationRotate(EventSystemOnPointerDownEvent e, ScreenForegroundNode screenForeground,
            [JoinAll] HangarCameraTankViewDecelerationRotateNode hangar) =>
            hangar.Entity.RemoveComponent<HangarCameraDecelerationRotateComponent>();

        [OnEventFire]
        public void StopDecelerationRotate(NodeRemoveEvent e, HangarCameraTankViewStateNode hangar,
            [JoinAll] HangarCameraTankViewDecelerationRotateNode hangarRotate) =>
