...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ShaftAimingReticleEffectSystem : ECSSystem {
        const string RETICLE_SPOT_COLOR_PROPERTY = "_TintColor";

        [OnEventFire]
        public void InitEffect(NodeAddedEvent evt, ShaftAimingReticleEffectNode weapon,
            [JoinAll] SingleNode<ScreensLayerComponent> canvasNode) {
            ...
            weapon.shaftAimingReticleEffect.CanvasSize = canvasNode.component.GetComponent<RectTransform>().rect.size;
            ...
            ShaftReticleSpotBehaviour shaftReticleSpotBehaviour =
                gameObject.GetComponentsInChildren<ShaftReticleSpotBehaviour>(true)[0];
        ...
        [OnEventFire]
        public void FinalizeEffect(NodeRemoveEvent evt, ShaftAimingReadyReticleForNRNode nr,
            [JoinSelf] ShaftAimingReadyReticleNode weapon) {
        ...
        public void UpdateEffectAlpha(UpdateEvent evt, ShaftAimingWorkActivationReticleEffectNode weapon) {
            ...
            float a = weapon.shaftAimingWorkActivationState.ActivationTimer /
            ...
            Vector2 vector3 = new(vector2.x / Screen.width * canvasSize.x, vector2.y / Screen.height * canvasSize.y);
        ...
        void UpdateImageAlpha(float a, ShaftAimingReticleEffectComponent effect) => effect.ReticleGroup.alpha = a;
