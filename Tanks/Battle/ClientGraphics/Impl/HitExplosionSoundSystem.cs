...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class HitExplosionSoundSystem : BaseHitExplosionSoundSystem {
        [OnEventFire]
        public void CreateHitSoundEffect(HitEvent evt, HitExplosionSoundNode weapon,
        ...
        [OnEventFire]
        public void Explosion(BulletHitEvent e, Node node, [JoinByTank] HitExplosionSoundNode weapon,
            [JoinAll] SingleNode<SoundListenerBattleStateComponent> soundListener) {
            HitExplosionSoundComponent hitExplosionSound = weapon.hitExplosionSound;
            GameObject soundPrefab = hitExplosionSound.SoundPrefab;
            float duration = hitExplosionSound.Duration;
