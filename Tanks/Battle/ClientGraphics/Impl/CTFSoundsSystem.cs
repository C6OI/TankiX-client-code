...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class CTFSoundsSystem : ECSSystem {
        const string EFFECT_NAME = "Effects";

        [OnEventFire]
        public void FillFlagSounds(NodeAddedEvent e, MapNode map, [JoinByMap] [Context] CTFNode battle,
            ...
            CTFSoundsComponent cTFSoundsComponent = new();
            GameObject gameObject = new("Effects");
        ...
        AudioSource CreateSound(GameObject prefab, GameObject effectRoot) {
        ...
        [OnEventFire]
        public void PlayDropSound(FlagDropEvent e, SingleNode<FlagComponent> flag,
            [JoinAll] SingleNode<CTFSoundsComponent> ctfSoundsNode) => ctfSoundsNode.component.FlagLost.Play();

        [OnEventFire]
        public void PlayReturnSound(FlagReturnEvent e, SingleNode<FlagComponent> flag,
            [JoinAll] SingleNode<CTFSoundsComponent> ctfSoundsNode) => ctfSoundsNode.component.FlagReturn.Play();

        [OnEventFire]
        public void PlayReturnSound(FlagPickupEvent e, SingleNode<FlagComponent> flag,
            [JoinAll] SingleNode<CTFSoundsComponent> ctfSoundsNode) => ctfSoundsNode.component.FlagStole.Play();

        [OnEventFire]
        public void PlayReturnSound(FlagDeliveryEvent e, SingleNode<FlagComponent> flag,
            [JoinAll] SingleNode<CTFSoundsComponent> ctfSoundsNode) => ctfSoundsNode.component.FlagWin.Play();
