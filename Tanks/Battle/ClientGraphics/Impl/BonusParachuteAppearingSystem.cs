...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class BonusParachuteAppearingSystem : ECSSystem {
        ...
        [OnEventFire]
        public void SeparateFoldingParachute(NodeAddedEvent e, AttachedFoldingParachuteNode bonusWithParachute,
            ...
            entity.AddComponent(separateParachuteComponent);

            entity.AddComponent(
                new BonusParachuteInstanceComponent(bonusWithParachute.bonusParachuteInstance.BonusParachuteInstance));
            ...
            bonusWithParachute.bonusParachuteInstance.BonusParachuteInstance.transform.parent = null;
        }
