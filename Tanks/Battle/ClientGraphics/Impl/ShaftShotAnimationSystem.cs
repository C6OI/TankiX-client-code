...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ShaftShotAnimationSystem : ECSSystem {
        ...
        public void InitShaftShotAnimation(NodeAddedEvent evt, InitialShaftShotAnimationNode weapon) {
            ...
            weapon.shaftShotAnimation.Init(animator,
                cooldownIntervalSec,
                unloadEnergyPerQuickShot,
                reloadEnergyPerSec,
                possibleUnloadEnergyPerAimingShot);

            weapon.shaftShotAnimationTrigger.Entity = entity;
            ShaftShotAnimationESMComponent shaftShotAnimationESMComponent = new();
        ...
        [OnEventFire]
        public void StartCooldown(ShaftShotAnimationCooldownStartEvent evt, ReadyShaftShotAnimationNode weapon,
            [JoinByTank] ActiveTankNode tank) => weapon.shaftShotAnimationEsm.Esm
            .ChangeState<ShaftShotAnimationStates.ShaftShotAnimationCooldownState>();

        [OnEventFire]
        public void UpdateShotAnimationDataWithinCooldown(UpdateEvent evt, ShaftShotAnimationCooldownStateNode state,
            [JoinByTank] ReadyShaftShotAnimationNode weapon) =>
            weapon.shaftShotAnimation.UpdateShotCooldownAnimation(evt.DeltaTime);

        [OnEventFire]
        public void StopCooldown(ShaftShotAnimationCooldownEndEvent evt, ReadyShaftShotAnimationNode weapon,
            [JoinByTank] ActiveTankNode tank) => weapon.shaftShotAnimationEsm.Esm
            .ChangeState<ShaftShotAnimationStates.ShaftShotAnimationIdleState>();

        [OnEventFire]
        public void StopShaftShotAnimtionEffect(NodeRemoveEvent evt, ActiveTankNode tank,
            [JoinByTank] ReadyShaftShotAnimationNode weapon) {
            weapon.shaftShotAnimation.Stop();
