...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ShaftAimingColorEffectSystem : ECSSystem {
        [OnEventFire]
        public void DefineColorForDM(NodeAddedEvent evt, ShaftAimingColorEffectNode weaponNode,
            [JoinByBattle] [Context] DMBattleNode dm) {
        ...
        [OnEventFire]
        public void DefineColorForTeamMode(NodeAddedEvent evt, [Combine] ShaftAimingTeamColorEffectNode weaponNode,
            [JoinByTeam] [Context] TeamNode team) {
            TeamColorComponent teamColor = team.teamColor;
            TeamColor teamColor2 = teamColor.TeamColor;
            ShaftAimingColorEffectComponent shaftAimingColorEffect = weaponNode.shaftAimingColorEffect;

            Color choosenColor = teamColor2 != TeamColor.BLUE ? shaftAimingColorEffect.RedColor
                                     : shaftAimingColorEffect.BlueColor;
