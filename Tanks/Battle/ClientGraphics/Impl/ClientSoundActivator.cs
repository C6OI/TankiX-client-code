...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ClientSoundActivator : UnityAwareActivator<AutoCompleting>, ECSActivator, Activator {
        ...
        public void RegisterSystemsAndTemplates() {
            ...
            EngineService.RegisterSystem(new MineSoundsSystem());
        ...
        protected override void Activate() => UpdateAudioConfiguration();
        ...
        void UpdateAudioConfiguration() {
            ...
            if (processorCount <= minProcessorCount) {
                ...
                int defaultQualityLevel = GraphicsSettings.INSTANCE.DefaultQualityLevel;
                int numRealVoices = maxRealVoicesByQualityIndex[defaultQualityLevel];
