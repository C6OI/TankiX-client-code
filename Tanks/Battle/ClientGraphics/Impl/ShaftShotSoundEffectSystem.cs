...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ShaftShotSoundEffectSystem : ECSSystem {
        [OnEventFire]
        public void InitShaftShotSoundEffects(NodeAddedEvent evt, [Combine] InitialShaftShotSoundEffectNode weapon,
        ...
        [OnEventFire]
        public void StopShaftShotSoundEffects(NodeRemoveEvent evt, ActiveTankNode tank,
            [JoinByTank] ReadyShaftShotSoundEffectNode weapon) {
        ...
        [OnEventFire]
        public void PlayShaftQuickShotEffect(BaseShotEvent evt, ReadyShaftShotSoundEffectNode weapon,
            [JoinByTank] SingleNode<ShaftIdleStateComponent> state, [JoinByTank] ActiveTankNode tank) {
            StopCooldownSounds(weapon);
            weapon.shaftAimingShotSoundEffect.Stop();
        ...
        [OnEventFire]
        public void PlayShaftAimingShotEffect(BaseShotEvent evt, ReadyShaftShotSoundEffectNode weapon,
            [JoinByTank] SingleNode<ShaftAimingWorkFinishStateComponent> state, [JoinByTank] ActiveTankNode tank) {
            StopCooldownSounds(weapon);
            weapon.shaftQuickShotSoundEffect.Stop();
        ...
        [OnEventFire]
        public void PlayShaftStartCooldownEffect(ShaftShotAnimationCooldownStartEvent evt,
            ReadyShaftShotSoundEffectNode weapon) {
        ...
        [OnEventFire]
        public void PlayShaftClosingCooldownEffect(ShaftShotAnimationCooldownClosingEvent evt,
            ReadyShaftShotSoundEffectNode weapon) {
            weapon.shaftStartCooldownSoundEffect.Stop();
            weapon.shaftClosingCooldownSoundEffect.Play();
        }

        void StopCooldownSounds(ReadyShaftShotSoundEffectNode weapon) {
            weapon.shaftStartCooldownSoundEffect.Stop();
            weapon.shaftClosingCooldownSoundEffect.Stop();
