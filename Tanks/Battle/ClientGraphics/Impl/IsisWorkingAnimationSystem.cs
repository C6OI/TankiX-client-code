...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class IsisWorkingAnimationSystem : ECSSystem {
        ...
        [OnEventFire]
        public void StartAnimation(NodeAddedEvent evt, IsisWorkingStateNode workingState,
            [JoinByTank] [Context] ReadyIsisWorkingAnimationNode weapon) =>
            weapon.isisWorkingAnimation.StartWorkingAnimation();

        [OnEventFire]
        public void StopAnimation(NodeRemoveEvent evt, IsisWorkingStateNode workingState,
            [JoinByTank] ReadyIsisWorkingAnimationNode weapon) => weapon.isisWorkingAnimation.StopWorkingAnimation();
