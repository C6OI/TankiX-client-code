...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class TankPartIntersectionWithCameraSystem : ECSSystem {
        ...
        void AttachColliderToIntersectionMap(VisualTriggerMarkerComponent trigger, Entity entity,
            TankPartIntersectionWithCameraData[] map, int index) {
        ...
        [OnEventFire]
        public void CheckCameraVisualIntersection(EarlyUpdateEvent evt, TankPartIntersectionWithCameraMapVisibleNode tank,
            [JoinAll] CameraNode camera) => CheckCameraVisualIntersection(tank, camera);

        [OnEventFire]
        public void ResetState(NodeRemoveEvent evt, TankPartIntersectionWithCameraMapVisibleNode tank) {
            TankPartIntersectionWithCameraData[] tankPartIntersectionMap =
                tank.tankPartIntersectionWithCameraMap.TankPartIntersectionMap;
        ...
        void CheckCameraVisualIntersection(TankPartIntersectionWithCameraMapVisibleNode tank, CameraNode camera) {
            Vector3 position = camera.camera.Camera.transform.position;
