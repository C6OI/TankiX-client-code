...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class StreamEffectBehaviour : MonoBehaviour {
        ...
        void LateUpdate() {
            ...
            nearIntensityTime = Mathf.Clamp(nearIntensityTime + easingDirection * deltaTime,
                0f,
                nearIntensityEasing.keys[nearIntensityEasing.keys.Length - 1].time);

            farIntensityTime = Mathf.Clamp(farIntensityTime + easingDirection * deltaTime,
                0f,
                farIntensityEasing.keys[farIntensityEasing.keys.Length - 1].time);
