...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class SupplyRegionShowSystem : ECSSystem {
        [OnEventFire]
        public void HideBonusRegion(NodeAddedEvent e, GroundedBonusNode bonus,
            [JoinByBonusRegion] VisibleSupplyBonusRegionNode bonusRegion) =>
            bonusRegion.Entity.RemoveComponent<VisibleBonusRegionComponent>();

        [OnEventFire]
        public void ShowBonusRegion(NodeRemoveEvent e, GroundedBonusNode bonus,
            [JoinByBonusRegion] InvisibleSupplyBonusRegionNode bonusRegion) =>
