...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class TrackDustSystem : ECSSystem {
        ...
        const int EMISSION_RAY_NUMBER = 2;

        [Inject] public static UnityTime UnityTime { get; set; }

        [OnEventFire]
        public void InitTrackDustSystem(NodeAddedEvent evt, [Combine] TrackDustInitNode tank,
            SingleNode<MapDustComponent> mapDust) {
            ...
            CollisionDustBehaviour collisionDustBehaviour =
                tank.hullInstance.HullInstance.AddComponent<CollisionDustBehaviour>();
        ...
        public void TryEmitFromTracks(UpdateEvent evt, TrackDustUpdateNode tankNode,
            [JoinAll] SingleNode<MapDustComponent> mapDustNode) {
        ...
        void TryEmitFromSuspensionRay(float maxCompression, Track track, MapDustComponent mapDust, float[] delays, int i) {
