...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class UpdateRankEffectDistortionMobile : MonoBehaviour {
        ...
        void Update() {
            ...
            if (Vector3.SqrMagnitude(instanceCameraTransform.position - oldPosition) <= 1E-05f &&
        ...
        void Initialize() {
            ...
            renderTexture = new RenderTexture(Mathf.RoundToInt(Screen.width * TextureScale),
                Mathf.RoundToInt(Screen.height * TextureScale),
                16,
                RenderTextureFormat);
