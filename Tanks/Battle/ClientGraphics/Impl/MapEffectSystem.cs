...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class MapEffectSystem : ECSSystem {
        ...
        [OnEventFire]
        public void RemoveMapEffect(NodeRemoveEvent e, SingleNode<MapInstanceComponent> map,
            [JoinByMap] SingleNode<MapEffectComponent> mapEffect) => DeleteEntity(mapEffect.Entity);
