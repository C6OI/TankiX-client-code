...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class TankFrictionSoundSystem : ECSSystem {
        [OnEventFire]
        public void InitTankFrictionSound(NodeAddedEvent evt, [Combine] InitialTankFrictionSoundNode tank,
            ...
            tankFrictionSoundEffect.MetallFrictionSourceInstance =
                InitSoundTransforms(metallFrictionSourcePrefab, soundRootTransform);

            tankFrictionSoundEffect.StoneFrictionSourceInstance =
                InitSoundTransforms(stoneFrictionSourcePrefab, soundRootTransform);

            tankFrictionSoundEffect.FrictionContactSourceInstance =
                InitSoundTransforms(frictionContactSourcePrefab, soundRootTransform);
            ...
            TankFrictionCollideSoundBehaviour tankFrictionCollideSoundBehaviour =
                tank.tankCollision.gameObject.AddComponent<TankFrictionCollideSoundBehaviour>();

            tankFrictionCollideSoundBehaviour.Init(tank.tankFrictionSoundEffect.FrictionContactSourceInstance,
                tank.rigidbody.Rigidbody,
                halfLength,
                tank.tankFallingSoundEffect.MinPower,
                tank.tankFallingSoundEffect.MaxPower);

            TankFrictionSoundEffectReadyComponent tankFrictionSoundEffectReadyComponent = new();
        ...
        public void PlayTankFrictionSound(UpdateEvent evt, ReadyActiveTankFrictionSoundNode tank) {
            TankFrictionSoundBehaviour tankFrictionSoundBehaviour =
                tank.tankFrictionSoundEffectReady.TankFrictionSoundBehaviour;
        ...
        SoundController InitSoundTransforms(SoundController sourcePrefab, Transform root) {
        ...
        void SetFriction(SoundController actualSource, SoundController stopSource,
            TankFrictionSoundEffectComponent tankFrictionSoundEffect, Vector3 velocity) {
            SetFrictionVolume(actualSource, tankFrictionSoundEffect, velocity);
            actualSource.FadeIn();
            stopSource.FadeOut();
        }

        void StopSounds(TankFrictionSoundEffectComponent tankFrictionSoundEffect) {
            tankFrictionSoundEffect.MetallFrictionSourceInstance.FadeOut();
            tankFrictionSoundEffect.StoneFrictionSourceInstance.FadeOut();
        }

        void SetMetallFriction(TankFrictionSoundEffectComponent tankFrictionSoundEffect, Vector3 velocity) => SetFriction(
            tankFrictionSoundEffect.MetallFrictionSourceInstance,
            tankFrictionSoundEffect.StoneFrictionSourceInstance,
            tankFrictionSoundEffect,
            velocity);

        void SetStoneFriction(TankFrictionSoundEffectComponent tankFrictionSoundEffect, Vector3 velocity) => SetFriction(
            tankFrictionSoundEffect.StoneFrictionSourceInstance,
            tankFrictionSoundEffect.MetallFrictionSourceInstance,
            tankFrictionSoundEffect,
            velocity);

        void SetFrictionVolume(SoundController sound, TankFrictionSoundEffectComponent tankFrictionSoundEffect,
            Vector3 velocity) {
        ...
        void SetVolumeByVelocity(SoundController sound, Vector3 velocity, float min, float max) {
