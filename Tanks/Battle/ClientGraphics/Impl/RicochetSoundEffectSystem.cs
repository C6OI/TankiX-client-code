...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class RicochetSoundEffectSystem : ECSSystem {
        [OnEventFire]
        public void InstantiateEffectOnStaticHit(RicochetBulletBounceEvent e, BulletNode bullet,
            [JoinByTank] RicochetSoundEffectNode weapon,
        ...
        [OnEventFire]
        public void InstantiateEffectOnTargetHit(BulletHitEvent e, BulletNode bullet,
            [JoinByTank] RicochetSoundEffectNode weapon,
            [JoinAll] SingleNode<SoundListenerBattleStateComponent> soundListener) {
