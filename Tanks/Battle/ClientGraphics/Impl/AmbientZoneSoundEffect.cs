...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class AmbientZoneSoundEffect : MonoBehaviour {
        ...
        public void DisableZoneTransition() => enabled = false;
        ...
        public void RegisterPlayingAmbientZone(AmbientSoundZone zone) => playingZones.Add(zone);

        public void UnregisterPlayingAmbientZone(AmbientSoundZone zone) => playingZones.Remove(zone);
