    ...
    public class ShaftAimingLaserBehaviour : MonoBehaviour {
        ...
        void InitializeLineRendererList<T>(List<LineRenderer> lineRenderers) where T : Component {
            ...
            for (int i = 0; i < array.Length; i++) {
                ...
                component.SetWidth(laserWidth, laserWidth);
        ...
        void UpdateAlphaForAllParts(float alpha) {
            ...
            UpdateAlpha(alpha,
                spot.material,
                beginLines[0].material,
                beginLines[1].material,
                baseLines[0].material,
                baseLines[1].material);
        }
        ...
        public void UpdateTargetPosition(Vector3 startPosition, Vector3 targetPosition, bool showLaser, bool showSpot) {
            ...
            Vector3 vector = Vector3.Normalize(Camera.main.transform.position - targetPosition);
        ...
        public void SetColor(Color color) {
            Color color2 = new(color.r, color.g, color.b, currentAlpha);
            spot.material.SetColor("_TintColor", color2);
            beginLines[0].material.SetColor("_TintColor", color2);
            beginLines[1].material.SetColor("_TintColor", color2);
            baseLines[0].material.SetColor("_TintColor", color2);
            baseLines[1].material.SetColor("_TintColor", color2);
        }
