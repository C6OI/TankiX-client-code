...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class DoubleArmorEffectSystem : ECSSystem {
        [OnEventFire]
        public void InitDoubleArmorEffect(NodeAddedEvent evt, [Combine] TankNode tank,
        ...
        [OnEventFire]
        public void StartDoubleArmorEffect(NodeAddedEvent evt, ArmorEffectNode effect,
            [JoinByTank] [Context] ReadyTankNode tank) => tank.doubleArmorEffect.Play();
