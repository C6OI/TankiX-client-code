...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class WeaponSoundRotationSystem : ECSSystem {
        [OnEventFire]
        public void CreateWeaponRotationSound(NodeAddedEvent evt, [Combine] WeaponSoundNode weaponNode,
        ...
        [OnEventComplete]
        public void UpdateWeaponRotationSound(UpdateEvent evt, ReadyWeaponSoundRotationNode weapon,
        ...
        [OnEventFire]
        public void StopWeaponRotationSound(NodeRemoveEvent evt, ActiveTankNode activeTank,
            [JoinByTank] ReadyWeaponSoundRotationNode weapon) => StopAudioSources(weapon.weaponRotationSound);

        [OnEventFire]
        public void StopWeaponRotationSound(NodeRemoveEvent evt, ReadyWeaponSoundRotationNode weapon) =>
            StopAudioSources(weapon.weaponRotationSound);

        void StartAudioSources(WeaponRotationSoundComponent sounds) {
            if (!sounds.IsActive) {
        ...
        void StopAudioSources(WeaponRotationSoundComponent sounds) {
            if (sounds.IsActive) {
