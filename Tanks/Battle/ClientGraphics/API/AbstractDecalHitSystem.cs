...
namespace Tanks.Battle.ClientGraphics.API {
    public abstract class AbstractDecalHitSystem : ECSSystem {
        protected void DrawHitDecal(HitEvent evt, DecalManagerComponent decalManager,
            DynamicDecalProjectorComponent decalProjector, MuzzlePointComponent muzzlePoint) {
        ...
        protected void DrawHitDecal(DecalManagerComponent managerComponent, DynamicDecalProjectorComponent decalProjector,
            ...
            if (managerComponent.DecalMeshBuilder.Build(decalProjection2, ref mesh)) {
                managerComponent.BulletHoleDecalManager.AddDecal(mesh,
