...
namespace Tanks.Battle.ClientRemoteServer.Impl {
    public static class MovementComparer {
        ...
        public static bool IsMovementAlmostEqual(ref Movement movement1, ref Movement movement2) =>
            CheckDistance(ref movement1, ref movement2) &&
            CheckRotation(ref movement1, ref movement2) &&
            CheckLinearVelocity(ref movement1, ref movement2) &&
            CheckAngularVelocity(ref movement1, ref movement2);

        static bool CheckDistance(ref Movement movement1, ref Movement movement2) =>
            Vector3.SqrMagnitude(movement1.Position - movement2.Position) < 0.09f;

        static bool CheckLinearVelocity(ref Movement movement1, ref Movement movement2) =>
        ...
        static bool CheckAngularVelocity(ref Movement movement1, ref Movement movement2) =>
            MathUtil.NearlyEqual(movement2.AngularVelocity, movement1.AngularVelocity, 0.17453292f);
    }
}