...
namespace Tanks.Battle.ClientCore.Impl {
    public class StreamWeaponEnergySystem : ECSSystem {
        [OnEventFire]
        public void StartReloading(NodeAddedEvent evt, StreamWeaponIdleEnergyNode weapon,
        ...
        [OnEventFire]
        public void ReloadEnergy(TimeUpdateEvent evt, StreamWeaponReloadingEnergyNode weapon,
