...
namespace Tanks.Battle.ClientCore.Impl {
    public class MouseControlSettingsSystem : ECSSystem {
        const float MouseSensivityRatio = 1.5f;

        [Inject] public static InputManager InputManager { get; set; }

        [OnEventFire]
        public void InitWeaponRotationControl(NodeAddedEvent e, SelfBattleUser selfBattleUser,
            SingleNode<GameMouseSettingsComponent> settings) {
