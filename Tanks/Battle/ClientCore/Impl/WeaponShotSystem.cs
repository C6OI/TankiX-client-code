    ...
    public class WeaponShotSystem : ECSSystem {
        ...
        public void SendShot(SendShotToServerEvent evt, UnblockedWeaponNode weaponNode) {
            ...
            if (evt.TargetingData.BestDirection != null) {
                ...
                selfShotEvent.ShotDirection = new MuzzleLogicAccessor(weaponNode.muzzlePoint, weaponNode.weaponInstance)
                    .GetFireDirectionWorld();
            }
        ...
        [OnEventFire]
        public void SendShot(ShotPrepareEvent evt, BlockedWeaponNode weaponNode) => ScheduleEvent(
            new SelfShotEvent(new MuzzleLogicAccessor(weaponNode.muzzlePoint, weaponNode.weaponInstance)
                .GetFireDirectionWorld()),
            weaponNode);

        [OnEventFire]
        public void SendShot(ShotPrepareEvent evt, UndergroundWeaponNode weaponNode) => ScheduleEvent(
            new SelfShotEvent(new MuzzleLogicAccessor(weaponNode.muzzlePoint, weaponNode.weaponInstance)
                .GetFireDirectionWorld()),
            weaponNode);
