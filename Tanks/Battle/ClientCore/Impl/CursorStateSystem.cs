...
namespace Tanks.Battle.ClientCore.Impl {
    public class CursorStateSystem : ECSSystem {
        ...
        public void SetCursor(NodeAddedEvent e, SingleNode<SelfBattleUserComponent> selfBattleUser) {
            CursorStateComponent component = new();
        ...
        public void SwitchCursorState(UpdateEvent evt, Spectator spectator) {
            if (InputManager.GetActionKeyDown(BattleActions.CURSOR)) {
                ...
                Cursor.lockState = !Cursor.visible && spectator.mouseControlStateHolder.MouseControlAllowed
        ...
        [OnEventFire]
        public void SetCursorWhenCloseChat(NodeRemoveEvent e, SingleNode<BattleChatStateComponent> battleChatState,
            UserAsTank userAsTank) {
        ...
        bool IsErrorScreen() {
            ...
            if (activeScene != SceneManager.GetSceneByName(SceneNames.FATAL_ERROR) &&
                activeScene != SceneManager.GetSceneByName(SceneNames.FATAL_BROKEN_RESOURCES)) {
                return false;
            }
