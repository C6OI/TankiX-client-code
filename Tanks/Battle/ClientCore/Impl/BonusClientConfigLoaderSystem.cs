...
namespace Tanks.Battle.ClientCore.Impl {
    public class BonusClientConfigLoaderSystem : ECSSystem {
        ...
        [OnEventFire]
        public void CollectComponentToBonusClientConfigEntity(NodeAddedEvent e,
            BonusClientConfigLoaderNode bonusConfigLoader, [JoinByBattle] SingleNode<BattleComponent> battle) {
        ...
        [OnEventFire]
        public void DeleteBonusClientConfigLoaderWhenBattleRemoved(NodeRemoveEvent e,
            SingleNode<BonusClientConfigPrefabComponent> battle,
            [JoinByBattle] BonusClientConfigLoaderForDeleteNode bonusConfigLoader) => DeleteEntity(bonusConfigLoader.Entity);
