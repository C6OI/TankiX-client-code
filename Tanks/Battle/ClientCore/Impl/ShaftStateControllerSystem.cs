...
namespace Tanks.Battle.ClientCore.Impl {
    public class ShaftStateControllerSystem : ECSSystem {
        ...
        [OnEventFire]
        public void InitWaitingStateOnInput(TimeUpdateEvent evt, ShaftIdleWeaponControllerNode weapon,
            [JoinByTank] SelfActiveTankNode activeTank) => StartWaitingStateIfPossible(weapon.Entity);
        ...
        [OnEventFire]
        public void CheckWeaponStateOnInactiveTank(NodeRemoveEvent evt, SelfActiveTankNode tank,
            [JoinByTank] ShaftWeaponNode weapon) =>
            StateUtils.SwitchEntityState<ShaftIdleStateComponent>(weapon.Entity, weaponStates);
