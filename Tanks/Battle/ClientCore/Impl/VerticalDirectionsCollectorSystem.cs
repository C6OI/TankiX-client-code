    ...
    public class VerticalDirectionsCollectorSystem : AbstractDirectionsCollectorSystem {
        ...
        public void CollectDirections(CollectDirectionsEvent evt, VerticalTargetingNode verticalTargeting) {
            ...
            if (verticalTargeting2.NumRaysUp > 0) {
                CollectSectorDirections(targetingData.Origin,
                    targetingData.Dir,
                    leftDirectionWorld,
                    verticalTargeting2.AngleUp / verticalTargeting2.NumRaysUp,
                    verticalTargeting2.NumRaysUp,
                    targetingData);
            }
            ...
            if (verticalTargeting2.NumRaysDown > 0) {
                CollectSectorDirections(targetingData.Origin,
                    targetingData.Dir,
                    leftDirectionWorld,
                    (0f - verticalTargeting2.AngleDown) / verticalTargeting2.NumRaysDown,
                    verticalTargeting2.NumRaysDown,
                    targetingData);
            }
        }
