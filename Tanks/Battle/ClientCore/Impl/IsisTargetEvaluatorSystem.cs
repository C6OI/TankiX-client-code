...
namespace Tanks.Battle.ClientCore.Impl {
    public class IsisTargetEvaluatorSystem : ECSSystem {
        ...
        [OnEventFire]
        public void ClearLastDirection(NodeRemoveEvent e, SingleNode<StreamHitComponent> weaponContext,
            [JoinSelf] SingleNode<IsisTargetEvaluatorComponent> weaponJoin) {
        ...
        public void EvaluateLastTank(TargetingEvaluateEvent e, HitNode weapon) {
            ...
            while (enumerator.MoveNext()) {
                ...
                while (enumerator2.MoveNext()) {
                    ...
                    if (current.Entity == weapon.streamHit.TankHit.Entity) {
        ...
        [OnEventFire]
        public void ResendEvaluateTeamTank(TargetingEvaluateEvent e, WeaponNode weapon,
            [JoinByTank] TeamTankNode shooterTank) {
            ...
            while (enumerator.MoveNext()) {
                ...
                while (enumerator2.MoveNext()) {
                    ...
                    NewEvent(new IsisEvaluateTeamTankEvent(current2, key)).Attach(weapon).Attach(current2.Entity).Schedule();
                }
            }
        }
