...
namespace Tanks.Battle.ClientCore.Impl {
    public class TankUpsideDownSystem : ECSSystem {
        ...
        [OnEventFire]
        public void MarkTankAsUpsideDown(CheckUpsideDownStateEvent e, SelfTankNode tank,
            [JoinByUser] SingleNode<UpsideDownConfigComponent> config) {
            float y = tank.rigidbody.Rigidbody.transform.up.y;
        ...
        [OnEventFire]
        public void ClearUpsideDownMark(CheckUpsideDownStateEvent e, UpsideDownSelfTankNode tank,
            [JoinByUser] SingleNode<UpsideDownConfigComponent> config) {
            float y = tank.rigidbody.Rigidbody.transform.up.y;
        ...
        [OnEventFire]
        public void ClearUpsideDownMarkOnTankRemove(NodeRemoveEvent e, UpsideDownSelfTankForNRNode nr,
            [JoinSelf] UpsideDownSelfTankNode tank) {
