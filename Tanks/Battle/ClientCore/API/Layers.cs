namespace Tanks.Battle.ClientCore.API {
    public class Layers {
        ...
        public static readonly int CASE = 8;
        ...
        public static readonly int DETACHED_WEAPON = 19;

        public static readonly int TANK_TO_TANK = 20;

        public static readonly int CHARACTER_SHADOW = 21;

        public static readonly int TANK_PART_VISUAL_TRIGGER = 22;
        ...
        public static readonly int GRASS_NEAR = 29;

        public static readonly int HANGAR = 30;

        public static readonly int GRASS_FAR = 31;
