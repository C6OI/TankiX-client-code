...
namespace Tanks.Battle.ClientCore.API {
    public static class MathUtil {
        ...
        public static Vector3 GetEulerAngles(Matrix4x4 m) {
            Vector3 vector = !(-1f < m.m20) || !(m.m20 < 1f)
                                 ? new Vector3(0f,
                                     0.5f * (!(m.m20 <= -1f) ? -(float)Math.PI : (float)Math.PI),
                                     Mathf.Atan2(0f - m.m01, m.m11)) : new Vector3(Mathf.Atan2(m.m21, m.m22),
                                     0f - Mathf.Asin(m.m20),
                                     Mathf.Atan2(m.m10, m.m00));
