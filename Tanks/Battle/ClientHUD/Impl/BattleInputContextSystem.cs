...
namespace Tanks.Battle.ClientHUD.Impl {
    public class BattleInputContextSystem : ECSSystem {
        ...
        [OnEventFire]
        public void OnFocus(ApplicationFocusEvent e, SingleNode<SelfBattleUserComponent> selfBattleUser,
        ...
        [OnEventFire]
        public void UpdateToScore(UpdateEvent e, SingleNode<SelfBattleUserComponent> selfBattleUser,
            [JoinAll] SingleNode<BattleActionsStateComponent> battleActionsState) {
        ...
        [OnEventFire]
        public void UpdateToScore(UpdateEvent e, SingleNode<SelfBattleUserComponent> selfBattleUser,
            [JoinAll] SingleNode<BattleShaftAimingStateComponent> battleShaftAimingState) {
            if (InputManager.GetActionKeyDown(BattleActions.SHOW_SCORE)) {
                InputManager.DeactivateContext(BasicContexts.MOUSE_CONTEXT);
            }
        }
        ...
        [OnEventComplete]
        public void Update(UpdateEvent e, SingleNode<SelfBattleUserComponent> selfBattleUser,
            [JoinAll] SingleNode<BattleShaftAimingStateComponent> battleShaftAimingState) {
        ...
        [OnEventFire]
        public void CheckMouseState(CheckMouseEvent e, SelfBattleUser selfBattleUser,
            Optional<SingleNode<SpectatorCameraComponent>> spectator) {
        ...
        [OnEventComplete]
        public void CheckMouseState(NodeAddedEvent e, SelfBattleUser selfBattleUser,
            SingleNode<BattleActionsStateComponent> battleActionsState,
            Optional<SingleNode<SpectatorCameraComponent>> spectator) {
            if (spectator.IsPresent()) {
                InputManager.DeactivateContext(BasicContexts.MOUSE_CONTEXT);
            } else if (selfBattleUser.mouseControlStateHolder.MouseControlAllowed &&
                       !InputManager.CheckAction(BattleActions.SHOW_SCORE)) {
                InputManager.ActivateContext(BasicContexts.MOUSE_CONTEXT);
            }
        }
