...
namespace Tanks.Battle.ClientHUD.Impl {
    public class SelfDestructionHUDSystem : ECSSystem {
        ...
        [OnEventFire]
        public void ShowOnActivate(NodeAddedEvent evt, SelfDestructionNode selfDestruction,
            [JoinByUser] SingleNode<SelfDestructionConfigComponent> config,
        ...
        [OnEventFire]
        public void HideOnDeactivate(NodeRemoveEvent e, SingleNode<TankActiveStateComponent> activeTank,
            [JoinByUser] SelfBattleUserNode selfBattleUser, [JoinAll] SelfDestructionServiceMessageNode serviceMessage) =>
            serviceMessage.serviceMessageESM.Esm.ChangeState<ServiceMessageStates.ServiceMessageHiddenState>();

        [OnEventFire]
        public void OnUpdate(TimeUpdateEvent evt, SelfDestructionServiceMessageNode selfDestruction,
            [JoinAll] SelfBattleUserNode selfBattleUser, [JoinAll] SingleNode<BattleScreenComponent> battleScreen) {
