...
namespace Tanks.Battle.ClientHUD.Impl {
    public class UpsideDownHUDSystem : ECSSystem {
        ...
        [OnEventFire]
        public void CheckPauseBeforeServiceMessageShown(NodeAddedEvent e, UpsideDownSelfTankNode tank,
            [JoinByUser] UserNode user, [JoinByUser] SingleNode<UpsideDownConfigComponent> config,
            [JoinAll] UpsideDownServiceMessageHiddenNode serviceMessage) {
        ...
        [OnEventFire]
        public void ShowMessage(ShowMessageEvent e, UpsideDownSelfTankNode tank,
            [JoinAll] UpsideDownServiceMessageHiddenNode serviceMessage,
        ...
        [OnEventFire]
        public void HideUpsideDownMessage(NodeRemoveEvent e, UpsideDownSelfTankNode tank,
            [JoinAll] UpsideDownServiceMessageNode serviceMessage) => serviceMessage.serviceMessageESM.Esm
