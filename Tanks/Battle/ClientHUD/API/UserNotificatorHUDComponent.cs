...
namespace Tanks.Battle.ClientHUD.API {
    public class UserNotificatorHUDComponent : BehaviourComponent {
        ...
        void OnEnable() {
            GetComponentsInChildren<BaseUserNotificationMessageBehaviour>(true).ForEach(
                delegate(BaseUserNotificationMessageBehaviour m) {
        ...
        void PlayNextNotification() => activeNotification.Play();
