...
namespace Edelweiss.DecalSystem {
    public class DecalsMeshCutter : GenericDecalsMeshCutter<Decals, DecalProjectorBase, DecalsMesh> {
        ...
        int CutEdgeOptimizedVerticesNormals(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
        ...
        int CutEdgeOptimizedVerticesNormalsTangents(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
            CutEdge a_CutEdge = new(a_IndexA, a_IndexB);
            int count = m_DecalsMesh.Vertices.Count;
            m_DecalsMesh.Vertices.Add(Vector3.Lerp(a_VertexA, a_VertexB, a_IntersectionFactorAB));
        ...
        int CutEdgeOptimizedVerticesNormalsUVs(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
            CutEdge a_CutEdge = new(a_IndexA, a_IndexB);
            int count = m_DecalsMesh.Vertices.Count;
            m_DecalsMesh.Vertices.Add(Vector3.Lerp(a_VertexA, a_VertexB, a_IntersectionFactorAB));
        ...
        int CutEdgeOptimizedVerticesNormalsTangentsUVs(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
            CutEdge a_CutEdge = new(a_IndexA, a_IndexB);
            int count = m_DecalsMesh.Vertices.Count;
            m_DecalsMesh.Vertices.Add(Vector3.Lerp(a_VertexA, a_VertexB, a_IntersectionFactorAB));
        ...
        int CutEdgeOptimizedVerticesNormalsUV2s(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
            CutEdge a_CutEdge = new(a_IndexA, a_IndexB);
            int count = m_DecalsMesh.Vertices.Count;
            m_DecalsMesh.Vertices.Add(Vector3.Lerp(a_VertexA, a_VertexB, a_IntersectionFactorAB));
        ...
        int CutEdgeOptimizedVerticesNormalsTangentsUV2s(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
            CutEdge a_CutEdge = new(a_IndexA, a_IndexB);
            int count = m_DecalsMesh.Vertices.Count;
            m_DecalsMesh.Vertices.Add(Vector3.Lerp(a_VertexA, a_VertexB, a_IntersectionFactorAB));
        ...
        int CutEdgeOptimizedVerticesNormalsUVsUV2s(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
            CutEdge a_CutEdge = new(a_IndexA, a_IndexB);
            int count = m_DecalsMesh.Vertices.Count;
            m_DecalsMesh.Vertices.Add(Vector3.Lerp(a_VertexA, a_VertexB, a_IntersectionFactorAB));
        ...
        int CutEdgeOptimizedVerticesNormalsTangentsUVsUV2s(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
            CutEdge a_CutEdge = new(a_IndexA, a_IndexB);
            int count = m_DecalsMesh.Vertices.Count;
            m_DecalsMesh.Vertices.Add(Vector3.Lerp(a_VertexA, a_VertexB, a_IntersectionFactorAB));
        ...
        int CutEdgeUnoptimized(int a_RelativeVertexLocationsOffset, int a_IndexA, int a_IndexB, Vector3 a_VertexA, Vector3 a_VertexB, bool a_IsVertexAInside,
            float a_IntersectionFactorAB) {
            CutEdge a_CutEdge = new(a_IndexA, a_IndexB);
