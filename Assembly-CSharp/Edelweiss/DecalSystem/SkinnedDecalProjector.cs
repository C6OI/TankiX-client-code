...
namespace Edelweiss.DecalSystem {
    public class SkinnedDecalProjector : SkinnedDecalProjectorBase {
        ...
        public SkinnedDecalProjector(Vector3 a_Position, Quaternion a_Rotation, Vector3 a_Scale, float a_CullingAngle, float a_meshOffset, int a_UV1RectangleIndex,
            int a_UV2RectangleIndex) {
            position = a_Position;
            rotation = a_Rotation;
            scale = a_Scale;
        ...
        public SkinnedDecalProjector(Vector3 a_Position, Quaternion a_Rotation, Vector3 a_Scale, float a_CullingAngle, float a_meshOffset, int a_UV1RectangleIndex,
            int a_UV2RectangleIndex, Color a_VertexColor, float a_VertexColorBlending) {
            position = a_Position;
            rotation = a_Rotation;
            scale = a_Scale;
            cullingAngle = a_CullingAngle;
