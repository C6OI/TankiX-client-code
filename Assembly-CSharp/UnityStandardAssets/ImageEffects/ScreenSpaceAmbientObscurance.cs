...
namespace UnityStandardAssets.ImageEffects {
    ...
    internal class ScreenSpaceAmbientObscurance : PostEffectsBase {
        [Range(0f, 3f)] public float intensity = 0.5f;

        [Range(0.1f, 3f)] public float radius = 0.2f;

        [Range(0f, 3f)] public int blurIterations = 1;

        [Range(0f, 5f)] public float blurFilterDistance = 1.25f;

        [Range(0f, 1f)] public int downsample;
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            Vector4 value = new(-2f / (Screen.width * projectionMatrix[0]), -2f / (Screen.height * projectionMatrix[5]), (1f - projectionMatrix[2]) / projectionMatrix[0],
