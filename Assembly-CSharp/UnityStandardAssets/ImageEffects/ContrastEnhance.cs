...
namespace UnityStandardAssets.ImageEffects {
    ...
    internal class ContrastEnhance : PostEffectsBase {
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            separableBlurMaterial.SetVector("offsets", new Vector4(0f, blurSpread * 1f / temporary2.height, 0f, 0f));
            ...
            separableBlurMaterial.SetVector("offsets", new Vector4(blurSpread * 1f / temporary2.width, 0f, 0f, 0f));
