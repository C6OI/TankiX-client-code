...
namespace UnityStandardAssets.ImageEffects {
    ...
    public class Bloom : PostEffectsBase {
        ...
        public Color flareColorD = new(0.8f, 0.4f, 0f, 0.75f);
        ...
        [HideInInspector] public Material brightPassFilterMaterial;
        ...
        public void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            for (int i = 0; i < bloomBlurIterations; i++) {
                float num3 = (1f + i * 0.25f) * sepBlurSpread;
            ...
            if (lensflareIntensity > Mathf.Epsilon) {
                ...
                if (lensflareMode == LensFlareStyle.Ghosting) {
                    ...
                    if (quality > BloomQuality.Cheap) {
                        blurAndFlaresMaterial.SetVector("_Offsets", new Vector4(0f, 1.5f / (1f * temporary.height), 0f, 0f));
                        Graphics.SetRenderTarget(temporary);
                        GL.Clear(false, true, Color.black);
                        Graphics.Blit(temporary5, temporary, blurAndFlaresMaterial, 4);
                        blurAndFlaresMaterial.SetVector("_Offsets", new Vector4(1.5f / (1f * temporary.width), 0f, 0f, 0f));
