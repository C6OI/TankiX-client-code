    ...
    internal class Triangles {
        ...
        static Mesh GetMesh(int triCount, int triOffset, int totalWidth, int totalHeight) {
            ...
            for (int i = 0; i < triCount; i++) {
                ...
                float num3 = Mathf.Floor(num2 % totalWidth) / totalWidth;
                float num4 = Mathf.Floor(num2 / totalWidth) / totalHeight;
                Vector3 vector = new(num3 * 2f - 1f, num4 * 2f - 1f, 1f);
                array[num] = vector;
                array[num + 1] = vector;
                array[num + 2] = vector;
