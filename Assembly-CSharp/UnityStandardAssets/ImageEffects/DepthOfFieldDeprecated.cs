    ...
    public class DepthOfFieldDeprecated : PostEffectsBase {
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            dofMaterial.SetVector("_CurveParams",
                new Vector4(!simpleTweakMode ? focalStartCurve : 1f / focalStartCurve, !simpleTweakMode ? focalEndCurve : 1f / focalEndCurve, num2 * 0.5f, focalDistance01));
        ...
        float FocalDistance01(float worldDist) => _camera.WorldToViewportPoint((worldDist - _camera.nearClipPlane) * _camera.transform.forward + _camera.transform.position).z /
