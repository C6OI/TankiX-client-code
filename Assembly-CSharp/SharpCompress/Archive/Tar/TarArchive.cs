...
namespace SharpCompress.Archive.Tar {
    public class TarArchive : AbstractWritableArchive<TarArchiveEntry, TarVolume> {
        ...
        protected override IEnumerable<TarVolume> LoadVolumes(IEnumerable<Stream> streams, Options options) => new TarVolume(streams.First(), options).AsEnumerable();
        ...
        protected override IEnumerable<TarArchiveEntry> LoadEntries(IEnumerable<TarVolume> volumes) {
            ...
            foreach (TarHeader header in TarHeaderFactory.ReadHeader(StreamingMode.Seekable, stream)) {
                ...
                if (previousHeader != null) {
                    TarArchiveEntry tarArchiveEntry = new(this, new TarFilePart(previousHeader, stream), CompressionType.None);
