...
namespace Tanks.ClientLauncher.Impl {
    public static class ClientUpdater {
        ...
        static readonly int FILE_WAIT_TIMEOUT = 80000;

        static readonly int FILE_WAIT_BEFORE_KILL_CONCURRENT_PROCESS = 10000;
        ...
        static void TryKillOtherTankixProcesses() {
            try {
        ...
        static void ReplaceProjectFiles(FileBackupTransaction transaction, string from, string to, string executableWithoutExtension) {
