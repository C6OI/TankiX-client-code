...
namespace Tanks.Lobby.ClientControls.API {
    ...
    public class LazyScrollableVerticalListComponent : MonoBehaviour, Component {
        ...
        bool IsPlaceholder(RectTransform transform) => transform.gameObject == aboveViewportPlaceholder.gameObject || transform.gameObject == belowViewportPlaceholder.gameObject;
