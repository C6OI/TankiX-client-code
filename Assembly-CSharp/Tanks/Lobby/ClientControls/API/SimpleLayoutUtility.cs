...
namespace Tanks.Lobby.ClientControls.API {
    public static class SimpleLayoutUtility {
        ...
        public static float GetFlexibleWidth(RectTransform rect) {
            return GetLayoutProperty(rect, e => e.flexibleWidth, 0f);
        }

        public static float GetFlexibleHeight(RectTransform rect) {
            return GetLayoutProperty(rect, e => e.flexibleHeight, 0f);
        }

        public static float GetMinWidth(RectTransform rect) {
            return GetLayoutProperty(rect, e => e.minWidth, 0f);
        }

        public static float GetMaxWidth(RectTransform rect) {
            return GetLayoutProperty(rect, e => e.maxWidth, 0f);
        }

        public static float GetMinHeight(RectTransform rect) {
            return GetLayoutProperty(rect, e => e.minHeight, 0f);
        }

        public static float GetMaxHeight(RectTransform rect) {
            return GetLayoutProperty(rect, e => e.maxHeight, 0f);
        }
