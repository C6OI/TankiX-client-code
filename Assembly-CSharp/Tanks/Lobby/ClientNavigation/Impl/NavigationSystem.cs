...
namespace Tanks.Lobby.ClientNavigation.Impl {
    public class NavigationSystem : ECSSystem {
        ...
        [OnEventFire]
        public void RegisterScreens(NodeAddedEvent e, SingleNode<ScreensRegistryComponent> navigationNode, [Combine] [Context] SingleNode<ScreensBundleComponent> screensBundleNode,
            SingleNode<ScreensLayerComponent> layerNode) {
            foreach (ScreenComponent screen in screensBundleNode.component.Screens) {
                Log.InfoFormat("RegisterScreens {0}", screen.gameObject.name);
        ...
        public void RequestShowScreen(ShowScreenEvent e, Node any, [JoinAll] SingleNode<ScreensRegistryComponent> navigationNode) {
            Log.InfoFormat("RequestShowScreen {0}", e.ShowScreenData.ScreenType.Name);
        ...
        void TryShowScreen(NavigationRequestNode navigationNode) {
            ...
            if (nonActiveScreen != null) {
                ...
                Log.WarnFormat("Skip remove RequestShowScreenComponent {0}", navigationNode.requestShowScreen.Event.ShowScreenData.ScreenType.Name);
            }
        }
        ...
        void ActivateShowingScreen(GameObject showingScreen, GameObject hidingScreen, ShowScreenData showScreenData, CurrentScreenComponent currentScreenComponent) {
        ...
        GameObject GetNonActiveScreen(Type screenType, ScreensRegistryComponent screens) => GetScreen(screenType, screens, false);

        GameObject GetActiveScreen(Type screenType, ScreensRegistryComponent screens) => GetScreen(screenType, screens, true);
