...
namespace Tanks.Lobby.ClientBattleSelect.API {
    ...
    public class ScoreTableRowComponent : MonoBehaviour, Component {
        ...
        public Dictionary<ScoreTableRowIndicator, ScoreTableRowIndicator> indicators = new();
        ...
        public void SetLayoutDirty() {
            transform.parent.GetComponent<ScoreTableComponent>().SetDirty();
        }
        ...
        public void AddIndicators(List<ScoreTableRowIndicator> indicatorsList) {
            foreach (ScoreTableRowIndicator indicators in indicatorsList) {
                ScoreTableRowIndicator scoreTableRowIndicator = Instantiate(indicators);
