...
namespace Tanks.Lobby.ClientGarage.Impl {
    public class DisplayMountButtonSystem : ECSSystem {
        ...
        [OnEventFire]
        public void HideMountButton(NodeAddedEvent e, NotMountedUserItemWithRestrictionNode item, [JoinAll] ScreenNode screenNode,
        ...
        [OnEventFire]
        public void ShowMountButton(NodeRemoveEvent e, NotMountedUserItemWithRestrictionNode item, [JoinAll] ScreenNode screenNode,
            [JoinByScreen] SingleNode<SelectedItemComponent> selectedItemNode) {
            if (selectedItemNode.component.SelectedItem == item.Entity) {
                ShowMountButton(screenNode, true);
            }
