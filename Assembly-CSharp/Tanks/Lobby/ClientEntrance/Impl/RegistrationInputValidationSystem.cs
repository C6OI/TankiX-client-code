...
namespace Tanks.Lobby.ClientEntrance.Impl {
    public class RegistrationInputValidationSystem : InputValidationSystem {
        [OnEventFire]
        public void ValidatePassword(InputFieldValueChangedEvent e, PasswordInputFieldNode passwordInputField, [JoinByScreen] SingleNode<PasswordErrorsComponent> strings,
        ...
        [OnEventFire]
        public void ValidatePassword(InputFieldValueChangedEvent e, PasswordInputFieldNode.NormalState passwordInputField, [JoinByScreen] LoginInputFieldNode loginInputField,
            [JoinByScreen] SingleNode<PasswordErrorsComponent> strings, [JoinAll] SingleNode<EntranceValidationRulesComponent> rules) {
        ...
        [OnEventFire]
        public void ValidatePassword(InputPausedEvent e, PasswordInputFieldNode.NormalState passwordInputField, [JoinByScreen] SingleNode<PasswordErrorsComponent> strings,
            [JoinAll] SingleNode<EntranceValidationRulesComponent> rules) {
            ChangePasswordInputFieldState(passwordInputField, strings.component, rules.component);
        }

        [OnEventFire]
        public void ValidatePassword(InputFieldValueChangedEvent e, LoginInputFieldNode loginInputField, [JoinByScreen] PasswordInputFieldNode passwordInput,
            [JoinByScreen] SingleNode<PasswordErrorsComponent> strings, [JoinAll] SingleNode<EntranceValidationRulesComponent> rules) {
        ...
        void ChangePasswordInputFieldState(BaseInputFieldNode<RegistrationPasswordInputComponent> passwordInputField, PasswordErrorsComponent strings,
            EntranceValidationRulesComponent rules) {
        ...
        [OnEventFire]
        public void SetNormalStateWhenPasswordInputChanged(InputFieldValueChangedEvent e, PasswordInputFieldNode passwordInputField,
            [JoinByScreen] RepetitionPasswordInputFieldNode repetitionPasswordInputField) {
            repetitionPasswordInputField.ToNormalState();
        }

        [OnEventFire]
        public void CheckRepetitionWhenPasswordInputValid(NodeAddedEvent e, PasswordInputFieldNode.ValidState passwordInputField,
            [JoinByScreen] RepetitionPasswordInputFieldNode repetitionPasswordInputField, [JoinByScreen] SingleNode<PasswordErrorsComponent> strings) {
            CheckRepetitionPassword(repetitionPasswordInputField, passwordInputField, strings.component);
        }

        [OnEventFire]
        public void ValidateRepetitionPassword(InputPausedEvent e, RepetitionPasswordInputFieldNode repetitionPasswordInputField,
            [JoinByScreen] PasswordInputFieldNode.ValidState passwordInputField, [JoinByScreen] SingleNode<PasswordErrorsComponent> strings) {
            CheckRepetitionPassword(repetitionPasswordInputField, passwordInputField, strings.component);
        }

        void CheckRepetitionPassword(BaseInputFieldNode<RepetitionPasswordInputComponent> repetitionPasswordInputField, PasswordInputFieldNode passwordInputField,
            PasswordErrorsComponent strings) {
