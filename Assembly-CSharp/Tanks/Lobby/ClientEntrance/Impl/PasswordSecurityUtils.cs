...
namespace Tanks.Lobby.ClientEntrance.Impl {
    public class PasswordSecurityUtils {
        ...
        public static string RSAEncryptAsString(string publicKeyBase64, byte[] data) => Convert.ToBase64String(RSAEncrypt(publicKeyBase64, data));

        public static byte[] GetDigest(string data) => DIGEST.ComputeHash(Encoding.UTF8.GetBytes(data));

        public static string GetDigestAsString(string data) => Convert.ToBase64String(DIGEST.ComputeHash(Encoding.UTF8.GetBytes(data)));
