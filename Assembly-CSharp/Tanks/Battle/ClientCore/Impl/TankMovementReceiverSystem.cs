...
namespace Tanks.Battle.ClientCore.Impl {
    public class TankMovementReceiverSystem : ECSSystem {
        ...
        bool IsBigRotation(ref Movement movement, ref Movement currentMovement) => Quaternion.Angle(currentMovement.Orientation, movement.Orientation) > BIG_ROTATION_DEGREES;
