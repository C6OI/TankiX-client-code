...
namespace Tanks.Battle.ClientCore.Impl {
    public class WeaponRotationInputSystem : ECSSystem {
        ...
        public void SwitchContextToAiming(NodeAddedEvent evt, SingleNode<ShaftAimingWorkActivationStateComponent> shaftNode,
            [JoinByUser] SingleNode<MouseControlStateHolderComponent> mouseControlStateHolder, [JoinByUser] SingleNode<SelfBattleUserComponent> selfBattleUser) {
            mouseControlStateHolder.component.MouseControlEnable =
                mouseControlStateHolder.component.MouseControlAllowed && InputManager.GetMouseButton(UnityInputConstants.MOUSE_BUTTON_LEFT);
        }

        [OnEventFire]
        public void OnWeaponUpdateEvent(UpdateEvent e, WeaponNode weapon, [JoinByTank] SelfTankNode tank,
            [JoinByUser] SingleNode<MouseControlStateHolderComponent> mouseControlStateHolder, [JoinAll] Optional<SingleNode<BattleShaftAimingStateComponent>> shaftAimingState) {
