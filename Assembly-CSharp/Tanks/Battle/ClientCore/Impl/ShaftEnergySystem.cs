...
namespace Tanks.Battle.ClientCore.Impl {
    public class ShaftEnergySystem : ECSSystem {
        ...
        [OnEventFire]
        public void StartReloading(NodeAddedEvent evt, ShaftEnergyNode weapon, [Context] [JoinByTank] SingleNode<ShaftIdleStateComponent> state,
        ...
        [OnEventFire]
        public void StartReloading(NodeAddedEvent evt, ShaftEnergyNode weapon, [Context] [JoinByTank] SingleNode<ShaftWaitingStateComponent> state,
            [Context] [JoinByTank] ActiveTankNode tank) {
            weapon.weaponEnergyEsm.Esm.ChangeState<WeaponEnergyStates.WeaponEnergyReloadingState>();
        }

        [OnEventFire]
        public void StartReloading(NodeAddedEvent evt, ShaftEnergyNode weapon, [Context] [JoinByTank] SingleNode<ShaftAimingWorkFinishStateComponent> state,
            [Context] [JoinByTank] ActiveTankNode tank) {
            weapon.weaponEnergyEsm.Esm.ChangeState<WeaponEnergyStates.WeaponEnergyReloadingState>();
        }

        [OnEventFire]
        public void StartUnloading(NodeAddedEvent evt, ShaftEnergyNode weapon, [Context] [JoinByTank] SingleNode<ShaftAimingWorkActivationStateComponent> state,
            [Context] [JoinByTank] ActiveTankNode tank) {
            weapon.weaponEnergyEsm.Esm.ChangeState<WeaponEnergyStates.WeaponEnergyUnloadingState>();
        }

        [OnEventFire]
        public void StartUnloading(NodeAddedEvent evt, ShaftEnergyNode weapon, [Context] [JoinByTank] SingleNode<ShaftAimingWorkingStateComponent> state,
            [Context] [JoinByTank] ActiveTankNode tank) {
            weapon.weaponEnergyEsm.Esm.ChangeState<WeaponEnergyStates.WeaponEnergyUnloadingState>();
        }
