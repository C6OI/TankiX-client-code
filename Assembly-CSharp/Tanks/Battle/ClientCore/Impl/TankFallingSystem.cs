...
namespace Tanks.Battle.ClientCore.Impl {
    public class TankFallingSystem : ECSSystem {
        ...
        void ApplyFall(Entity tankEntity, Vector3 previousVelocity, TankFallingComponent tankFalling, TrackComponent track, ChassisConfigComponent chassisConfig,
            TankCollisionComponent tankCollision, RigidbodyComponent rigidbody, bool fallingByTrack) {
        ...
        void UpdateGroundedStatus(TankFallingComponent tankFalling, int deltaTrackContacts, int currentCollisionContactsCount, int currentTrackContactsCount) {
        ...
        Vector3 GetFallingNrm(bool fallingByTrack, TrackComponent track, ChassisConfigComponent chassisConfig, TankCollisionComponent tankCollision, out bool isFallingOnTank) {
        ...
        bool ValidateCollider(Collider collider) {
            if (collider == null) {
                return false;
            }
        ...
        bool CheckTankCollisionNotNull(TankCollisionComponent tankCollision) => tankCollision.HasCollision && tankCollision.Collision != null && tankCollision.Collision.rigidbody != null;
