...
namespace Tanks.Battle.ClientCore.Impl {
    public class BattleShutdownNotificationSystem : ECSSystem {
        ...
        [OnEventFire]
        public void UpdateTimeNotification(UpdateEvent e, NotificationMessageNode notification, [JoinAll] SelfBattleNode battle,
            [JoinAll] [Combine] SingleNode<LocalizedTimerComponent> timer) {
