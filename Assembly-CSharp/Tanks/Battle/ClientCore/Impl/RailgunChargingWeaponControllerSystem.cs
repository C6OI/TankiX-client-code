...
namespace Tanks.Battle.ClientCore.Impl {
    public class RailgunChargingWeaponControllerSystem : ECSSystem {
        ...
        [OnEventFire]
        public void StartShotIfPossible(EarlyUpdateEvent evt, ReadyRailgunChargingWeaponControllerNode chargingWeaponController, [JoinSelf] SingleNode<ShootableComponent> node,
