    ...
    public class ShaftHitSystem : ECSSystem {
        ...
        public void SendHitToServer(SendHitToServerEvent e, ShaftNode weapon) {
            if (e.TargetingData.BestDirection.HasAnyHit()) {
                SelfShaftAimingHitEvent selfShaftAimingHitEvent = new(HitTargetAdapter.Adapt(e.TargetingData.BestDirection.Targets), e.TargetingData.BestDirection.StaticHit);
