...
namespace Tanks.Battle.ClientCore.Impl {
    public class ServerShutdownNotificationSystem : ECSSystem {
        ...
        [OnEventFire]
        public void UpdateTimeNotification(UpdateEvent e, NotificationMessageNode notification, [JoinAll] ShutdownNode shutdown,
            [Combine] [JoinAll] SingleNode<LocalizedTimerComponent> timer) {
