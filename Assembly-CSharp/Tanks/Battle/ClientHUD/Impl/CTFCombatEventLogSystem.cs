...
namespace Tanks.Battle.ClientHUD.Impl {
    public class CTFCombatEventLogSystem : ECSSystem {
        ...
        [OnEventFire]
        public void AddMessageLog(FlagEvent e, FlagNode flag, [JoinByTank] TankNode tank2Team, [JoinByTeam] TeamNode tankTeam, FlagNode flag2User, [JoinByTank] TankNode tank2User,
            [JoinByUser] UserNode user, FlagNode flag2Team, [JoinByTeam] TeamNode flagTeam, [JoinAll] SingleNode<SelfBattleUserComponent> selfUser,
        ...
        [OnEventFire]
        public void AddMessageAutoReturnedFlag(FlagReturnEvent e, NotCarriedFlagNode flag, [JoinByTeam] TeamNode flagTeam, [JoinAll] SingleNode<SelfBattleUserComponent> selfUser,
            [JoinByTeam] Optional<TeamNode> selfTeam, [JoinAll] CombatLogNode combatEventLog) {
        ...
        static string GetOwnFlag(Optional<TeamNode> selfTeam, TeamNode flagTeam, CombatLogCTFMessagesComponent logCtfMessages) {
