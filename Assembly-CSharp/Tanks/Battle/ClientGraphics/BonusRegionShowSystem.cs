...
namespace Tanks.Battle.ClientGraphics {
    public class BonusRegionShowSystem : ECSSystem {
        ...
        [OnEventFire]
        public void UpdateRegionOpacityByDistance(TimeUpdateEvent e, TankNode tank, [JoinAll] [Combine] VisibleBonusRegionNode region,
            [JoinAll] SingleNode<BonusRegionClientConfigComponent> configNode, [JoinAll] SingleNode<RoundActiveStateComponent> round) {
