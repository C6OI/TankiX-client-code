...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class IsisRayEffectBehaviour : MonoBehaviour {
        ...
        void SetBlobs(ParticleSystem nearBlob, ParticleSystemRenderer nearBlobRenderer, Light nearLight, Animation nearAnimation, ParticleSystem farBlob,
            ParticleSystemRenderer farBlobRenderer, Light farLight, Animation farAnimation) {
        ...
        void InitCurve() {
            ...
            for (int i = 0; i < array.Length; i++) {
                ...
                array[i].value = Mathf.Sin((array[i].time * curvesCount + value) * ((float)Math.PI * 2f)) * Random.Range(minCurveMagnitude, maxCurveMagnitude);
            }
