...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ShaftAimingMapEffectSystem : ECSSystem {
        ...
        [OnEventFire]
        public void StartHiding(NodeAddedEvent evt, ShaftAimingMapWorkingNode weapon, [JoinByBattle] ICollection<BonusBoxNode> bonuses, [JoinAll] ICollection<BonusRegionNode> regions,
            ShaftAimingMapWorkingNode weaponToJoinParachutes, [JoinByBattle] ICollection<BonusParachuteNode> parachutes, ShaftAimingMapWorkingNode weaponToJoinFlags,
            [JoinByBattle] ICollection<FlagNode> flags, [JoinAll] ICollection<SingleNode<MapHidingGeometryComponent>> hidingGeometryCollection) {
            float timeSinceLevelLoad = Time.timeSinceLevelLoad;
        ...
        void EnableHidingItem(Material material, ShaftAimingMapWorkingNode weapon, Shader targetShader, int targetRenderQueue, float startTime) {
        ...
        [OnEventFire]
        public void StopHiding(NodeAddedEvent evt, AimingMapIdleNode weapon, [JoinByBattle] ICollection<BonusBoxNode> bonuses, [JoinAll] ICollection<BonusRegionNode> regions,
            AimingMapIdleNode weaponToJoinParachutes, [JoinByBattle] ICollection<BonusParachuteNode> parachutes, AimingMapIdleNode weaponToJoinFlags,
            [JoinByBattle] ICollection<FlagNode> flags, [JoinAll] ICollection<SingleNode<MapHidingGeometryComponent>> hidingGeometryCollection) {
            foreach (BonusBoxNode bonuse in bonuses) {
        ...
        void EnableMaterialHiding(Material material, Vector4 hidingCenter, float speed, float maxRadius, float minRadius, float startTime) {
        ...
        void DisableMaterialHiding(Material material, int renderQueue) {
