...
namespace Tanks.Battle.ClientGraphics.Impl {
    ...
    public class FreezeMotionAnimationComponent : MonoBehaviour, Component {
        ...
        void StartMode(float currentEnergyLevel, bool isWorking) {
            ...
            coeffChangeSpeed = isWorking ? coefAcceleration :
                               !(num > 0f) ? 0f - coefAcceleration : 0f - Mathf.Max(0f, (currentSpeedMultiplier - idleAnimationSpeedMultiplier) / num * freezeEnergyReloadingSpeed);
