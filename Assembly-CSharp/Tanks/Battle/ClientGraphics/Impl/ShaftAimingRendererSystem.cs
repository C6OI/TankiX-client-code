...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ShaftAimingRendererSystem : ECSSystem {
        [OnEventFire]
        public void StartReducing(NodeAddedEvent evt, AimingWorkActivationNode weapon, [JoinByTank] TankActivationInvisibilityEffectNode tank,
            [JoinByTank] ICollection<RendererNode> renderers) {
            StartReducing(weapon, tank, renderers, false);
        }

        [OnEventFire]
        public void StartReducing(NodeAddedEvent evt, AimingWorkActivationNode weapon, [JoinByTank] TankDeactivationInvisibilityEffectNode tank,
            [JoinByTank] ICollection<RendererNode> renderers) {
            StartReducing(weapon, tank, renderers, false);
        }

        [OnEventFire]
        public void StartReducing(NodeAddedEvent evt, AimingWorkActivationNode weapon, [JoinByTank] TankWorkingInvisibilityEffectNode tank,
            [JoinByTank] ICollection<RendererNode> renderers) {
            StartReducing(weapon, tank, renderers, false);
        }
        ...
        void StartReducing(AimingWorkActivationNode weapon, TankNode tank, ICollection<RendererNode> renderers, bool switchShader) {
        ...
        [OnEventFire]
        public void SetOpaqueModeOnExitTankActiveState(NodeRemoveEvent evt, TankNode tank, [JoinByTank] ShaftAimingRendererEffectNode weapon,
            [JoinByTank] ICollection<RendererNode> renderers) {
        ...
        void SetTransparentMode(ICollection<RendererNode> renderers, TankNode tank, Shader targetShader = null, float alpha = -1f) {
            foreach (RendererNode renderer in renderers) {
