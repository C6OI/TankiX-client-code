        ...
        List<Zone> CombineZones(List<Submesh> parts, float maxSize) {
            ...
            for (int i = 0; i < parts.Count; i++) {
                ...
                for (int j = i + 1; j < parts.Count; j++) {
                    ...
                    if (!submesh2.merged && !(submesh2.material != submesh.material) && submesh2.lightmapIndex == submesh.lightmapIndex &&
                ...
                foreach (int num2 in triangles) {
                    ...
                    if (!dictionary.ContainsKey(num2)) {
                        ...
                        if (array3 != null) {
                            ...
                            Vector4 item2 = !(num7 < 1E-06) ? new Vector4(num4 / num7, num5 / num7, num6 / num7, vector3.w) : new Vector4(1f, 0f, 0f, vector3.w);
                            list5.Add(item2);
                        }
                        ...
                        if (array2 != null) {
                            ...
                            Vector3 item3 = !(num11 < 1E-06) ? new Vector3(num8 / num11, num9 / num11, num10 / num11) : vector;
                            list4.Add(item3);
                        }
