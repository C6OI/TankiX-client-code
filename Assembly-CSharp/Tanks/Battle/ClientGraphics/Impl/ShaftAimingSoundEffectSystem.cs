...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ShaftAimingSoundEffectSystem : ECSSystem {
        [OnEventFire]
        public void InstantiateAimingSoundsEffectsForSelfWeapon(NodeAddedEvent evt, [Combine] InitialSelfShaftAimingSoundsEffectNode weapon,
        ...
        [OnEventFire]
        public void InstantiateAimingSoundsEffectsForRemoteWeapon(NodeAddedEvent evt, [Combine] InitialRemoteShaftAimingSoundsEffectNode weapon,
            [Combine] [Context] [JoinByTank] RemoteTankNode tank, SingleNode<SoundListenerBattleStateComponent> soundListener) {
            Transform transform = weapon.weaponSoundRoot.transform;
        ...
        [OnEventFire]
        public void InstantiateAimingSoundsEffectsForAnyWeapon(NodeAddedEvent evt, [Combine] InitialAnyShaftAimingSoundsEffectNode weapon,
            SingleNode<SoundListenerBattleStateComponent> soundListener) {
            Transform transform = weapon.weaponSoundRoot.transform;
