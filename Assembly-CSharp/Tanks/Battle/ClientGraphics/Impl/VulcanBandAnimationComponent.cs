...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class VulcanBandAnimationComponent : ECSBehaviour, Component {
        ...
        [SerializeField] string[] textureNames = new string[6] { "_MainTex", "_PaintMap", "_FrostTex", "_HeatTex", "_SurfaceMap", "_BumpMap" };
        ...
        void Update() {
            ...
            if (isEjectorEnabled) {
                ...
                ProvideCaseEjectionEvent(EngineService.Engine);
            }
