...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class KalmanFilter {
        ...
        void MeasurementUpdateCorrection(Vector3 data) {
            float num = FACTOR_MEASURED_VALUE_TO_PREVIOUS_VALUE * predictedCovariance /
                        (FACTOR_MEASURED_VALUE_TO_PREVIOUS_VALUE * predictedCovariance * FACTOR_MEASURED_VALUE_TO_PREVIOUS_VALUE + ENVIRONMENT_NOISE);
