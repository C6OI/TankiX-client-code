...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class ChassisAnimationSystem : ECSSystem {
        ...
        public void AnimateWheelsAndTracksPosition(TimeUpdateEvent evt, ChassisAnimationNode node) {
            if (GraphicsSettings.INSTANCE.CurrentQualityLevel <= 1 && node.Entity.HasComponent<SelfTankComponent>() ||
                GraphicsSettings.INSTANCE.CurrentQualityLevel > 1 && node.cameraVisibleTrigger.IsVisibleAtRange(50f)) {
