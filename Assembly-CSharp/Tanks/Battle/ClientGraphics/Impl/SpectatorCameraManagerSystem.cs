    ...
    public class SpectatorCameraManagerSystem : ECSSystem {
        ...
        public void Screenshot(UpdateEvent evt, SingleNode<SpectatorCameraComponent> cameraNode) {
            if (InputManager.CheckAction(SpectatorCameraActions.Screenshot)) {
                ScreenCapture.CaptureScreenshot(SCREEN_SHOT_FILE_NAME + "_" + cameraNode.component.SequenceScreenshot + ".png");
            }
        }
        ...
        [OnEventFire]
        public void SwitchFollowedUser(SwitchFollowedUserEvent e, UserUidNode userNode1, [JoinByUser] FollowedBattleUserNode followedUser,
            [JoinByBattle] ICollection<UserUidNode> allUserUids, UserUidNode userNode2, [JoinByBattle] ICollection<ReadyBattleUserAsTankNode> tankUsers) {
        ...
        [OnEventFire]
        public void SetNewTargetToCamera(SetNewTargetCameraEvent e, UserUidNode user, [JoinByUser] BattleUserNode battleUser, [JoinAll] FollowedBattleUserNode prevFollowedUser,
            [JoinAll] FollowCameraNode camera) {
        ...
        [OnEventFire]
        public void SetNewTargetToCamera(SetNewTargetCameraEvent e, UserUidNode user, [JoinByUser] BattleUserNode battleUser, [JoinAll] FollowedBattleUserNode prevFollowedUser,
            [JoinAll] MouseOrbitCameraNode camera) {
            prevFollowedUser.Entity.RemoveComponent<FollowedBattleUserComponent>();
            battleUser.Entity.AddComponent<FollowedBattleUserComponent>();
        ...
        List<UserUidNode> FilterUsers(ICollection<UserUidNode> users, ICollection<ReadyBattleUserAsTankNode> tanks, UserUidNode currentUser, FollowedBattleUserNode currentBattleUser) {
            ...
            if (currentBattleUser.Entity.HasComponent<TeamGroupComponent>()) {
                ...
                List<ReadyBattleUserAsTankNode> list = tanksList.Where(tank => tank.Entity.GetComponent<TeamGroupComponent>().Key != currentTeamKey).ToList();
            ...
            List<UserUidNode> list2 = users.Where(user => tanksList.Exists(tank => user.userGroup.Key == tank.userGroup.Key)).ToList();
        ...
        UserUidNode GetUserUidForFollowingTank(List<UserUidNode> userUids, UserUidNode currentTargetUserUid, SwitchUserDirection switchUserDirection) {
        ...
        [OnEventFire]
        public void FollowUser(CameraFollowEvent e, BattleUserNode battleUser, [JoinAll] Optional<FollowedBattleUserNode> prevFollowedBattleUser,
        ...
        [OnEventFire]
        public void FollowNewUser(NodeAddedEvent e, FollowedBattleUserNode followedBattleUser, [JoinByUser] WeaponInstanceNode weaponInstanceNode,
            [JoinAll] [Combine] Optional<SingleNode<TeleportCameraIntentComponent>> moveIntent) {
        ...
        [OnEventComplete]
        public void ReturnToFreeCamera(NodeRemoveEvent e, BattleUserNode battleUser, [JoinByUser] FollowedBattleUserNode followedBattleUser,
            [JoinAll] SingleNode<CameraESMComponent> camera) {
        ...
        public class SwitchFollowedUserEvent : Event {
            ...
            public SwitchFollowedUserEvent(SwitchUserDirection switchUserDirection) => this.switchUserDirection = switchUserDirection;
        }
