...
namespace Tanks.Battle.ClientGraphics.Impl {
    public static class CameraPositionCalculator {
        ...
        public static Vector3 CalculateCameraPosition(Transform target, BaseRendererComponent tankRendererComponent, Vector3 tankBoundsCenter, BezierPosition bezierPosition,
            CameraData cameraData, Vector3 cameraOffset, float additionalAngle) {
        ...
        static Vector3 CalculateCollisionPoint(Vector3 targetPosition, Vector3 cameraDirection, float rayLength, GameObject exlusionGameObject, out bool hasCollision) {
        ...
        public static TransformData GetTargetFollowCameraTransformData(Transform target, BaseRendererComponent tankRendererComponent, Vector3 tankBoundsCenter,
            BezierPosition bezierPosition, Vector3 cameraOffset) {
