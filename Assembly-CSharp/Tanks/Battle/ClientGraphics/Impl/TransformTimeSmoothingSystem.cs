        ...
        public void TransformSmoothCalculation(TransformTimeSmoothingEvent e, TimeSmoothingNode node) {
            ...
            if (node.transformTimeSmoothing.UseCorrectionByFrameLeader && !flag) {
                ...
                if (frameLeaderDeltaAngle > num5 && transformTimeSmoothingData.LastRotationDeltaAngle > num5) {
                    num3 = Mathf.Abs((transformTimeSmoothingData.LastRotationDeltaAngle * (1f - transformTimeSmoothingData.LerpFactor) +
                                      frameLeaderDeltaAngle * transformTimeSmoothingData.LerpFactor) / frameLeaderDeltaAngle);
                }

                if (frameLeaderDeltaPosition > num5) {
                    num4 = Mathf.Abs((frameLeaderDeltaPosition * (1f - transformTimeSmoothingData.LerpFactor) + frameLeaderDeltaPosition * transformTimeSmoothingData.LerpFactor) /
