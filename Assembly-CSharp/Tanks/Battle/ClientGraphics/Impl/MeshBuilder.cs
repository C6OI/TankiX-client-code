...
namespace Tanks.Battle.ClientGraphics.Impl {
    public class MeshBuilder {
        ...
        public List<Vector2> UVs2 { get; } = new(100);
        ...
        public Vector4[] CalculateTangents() {
            ...
            for (int i = 0; i < num; i++) {
                ...
                Vector3 vector7 = new((num15 * num6 - num14 * num7) * num17, (num15 * num8 - num14 * num9) * num17, (num15 * num10 - num14 * num11) * num17);
                Vector3 vector8 = new((num12 * num7 - num13 * num6) * num17, (num12 * num9 - num13 * num8) * num17, (num12 * num11 - num13 * num10) * num17);
                array2[num3] += vector7;
                array2[num4] += vector7;
                array2[num5] += vector7;
                array3[num3] += vector8;
