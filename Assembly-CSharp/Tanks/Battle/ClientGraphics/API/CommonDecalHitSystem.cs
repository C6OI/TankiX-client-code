...
namespace Tanks.Battle.ClientGraphics.API {
    public class CommonDecalHitSystem : AbstractDecalHitSystem {
        ...
        public void Init(NodeAddedEvent evt, SingleNode<MapInstanceComponent> mapInstance, SingleNode<DecalSettingsComponent> settingsNode) {
            ...
            decalManagerComponent.BulletHoleDecalManager =
                new BulletHoleDecalManager(mapInstance.component.SceneRoot, component.MaxCount, component.LifeTimeMultipler, decalManagerComponent.DecalsQueue);
        ...
        [OnEventFire]
        public void DrawHitDecal(HitEvent evt, SingleNode<DynamicDecalProjectorComponent> decalProjectorNode, [JoinByTank] SingleNode<MuzzlePointComponent> muzzlePointNode,
        ...
        [OnEventFire]
        public void DrawBulletHitDecal(BulletHitEvent evt, Node node, [JoinByTank] SingleNode<DynamicDecalProjectorComponent> decalHitNode,
