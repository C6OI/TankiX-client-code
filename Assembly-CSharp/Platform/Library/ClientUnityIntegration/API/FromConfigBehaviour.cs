...
namespace Platform.Library.ClientUnityIntegration.API {
    public class FromConfigBehaviour : ECSBehaviour {
        ...
        static readonly Regex specialNames = new("(Component)|(Text)|(Texts)|(Localization)|(LocalizedStrings)", RegexOptions.IgnoreCase);
        ...
        [HideInInspector] [SerializeField] string yamlKey;
        ...
        public virtual string YamlKey => !IsStaticYamlKey ? yamlKey : naming.Apply(specialNames.Replace(GetType().Name, string.Empty));
        ...
        string NamespaceToConfigPath() => namespaceToConfigPath.Replace(GetType().Namespace, string.Empty).Replace(".", "/").ToLower() + GetRelativeConfigPath();
