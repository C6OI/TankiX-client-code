...
namespace Platform.System.Data.Statics.ClientYaml.Impl {
    public static class CloneObjectUtil {
        ...
        public static bool HasDefaultConstructor(Type type) => type.IsValueType || type.GetConstructor(BindingFlags.Instance | BindingFlags.Public, null, Type.EmptyTypes, null) != null;
    }
}