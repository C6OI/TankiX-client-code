namespace Steamworks {
    public static class SteamHTTP {
        public static HTTPRequestHandle CreateHTTPRequest(EHTTPMethod eHTTPRequestMethod, string pchAbsoluteURL) {
            ...
            using (InteropHelp.UTF8StringHandle pchAbsoluteURL2 = new(pchAbsoluteURL)) {
        ...
        public static bool SetHTTPRequestHeaderValue(HTTPRequestHandle hRequest, string pchHeaderName, string pchHeaderValue) {
            ...
            using (InteropHelp.UTF8StringHandle pchHeaderName2 = new(pchHeaderName)) {
                using (InteropHelp.UTF8StringHandle pchHeaderValue2 = new(pchHeaderValue)) {
        ...
        public static bool SetHTTPRequestGetOrPostParameter(HTTPRequestHandle hRequest, string pchParamName, string pchParamValue) {
            ...
            using (InteropHelp.UTF8StringHandle pchParamName2 = new(pchParamName)) {
                using (InteropHelp.UTF8StringHandle pchParamValue2 = new(pchParamValue)) {
        ...
        public static bool SetHTTPRequestRawPostBody(HTTPRequestHandle hRequest, string pchContentType, byte[] pubBody, uint unBodyLen) {
            ...
            using (InteropHelp.UTF8StringHandle pchContentType2 = new(pchContentType)) {
        ...
        public static bool SetCookie(HTTPCookieContainerHandle hCookieContainer, string pchHost, string pchUrl, string pchCookie) {
            ...
            using (InteropHelp.UTF8StringHandle pchHost2 = new(pchHost)) {
                using (InteropHelp.UTF8StringHandle pchUrl2 = new(pchUrl)) {
                    using (InteropHelp.UTF8StringHandle pchCookie2 = new(pchCookie)) {
        ...
        public static bool SetHTTPRequestUserAgentInfo(HTTPRequestHandle hRequest, string pchUserAgentInfo) {
            ...
            using (InteropHelp.UTF8StringHandle pchUserAgentInfo2 = new(pchUserAgentInfo)) {
