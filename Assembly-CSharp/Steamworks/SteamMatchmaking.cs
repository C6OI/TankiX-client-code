...
namespace Steamworks {
    public static class SteamMatchmaking {
        ...
        public static bool GetFavoriteGame(int iGame, out AppId_t pnAppID, out uint pnIP, out ushort pnConnPort, out ushort pnQueryPort, out uint punFlags,
        ...
        public static void AddRequestLobbyListStringFilter(string pchKeyToMatch, string pchValueToMatch, ELobbyComparison eComparisonType) {
            ...
            using (InteropHelp.UTF8StringHandle pchKeyToMatch2 = new(pchKeyToMatch)) {
                using (InteropHelp.UTF8StringHandle pchValueToMatch2 = new(pchValueToMatch)) {
