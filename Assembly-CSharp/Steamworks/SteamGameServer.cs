namespace Steamworks {
    public static class SteamGameServer {
        public static bool InitGameServer(uint unIP, ushort usGamePort, ushort usQueryPort, uint unFlags, AppId_t nGameAppId, string pchVersionString) {
            ...
            using (InteropHelp.UTF8StringHandle pchVersionString2 = new(pchVersionString)) {
        ...
        public static void SetProduct(string pszProduct) {
            ...
            using (InteropHelp.UTF8StringHandle pszProduct2 = new(pszProduct)) {
        ...
        public static void SetGameDescription(string pszGameDescription) {
            ...
            using (InteropHelp.UTF8StringHandle pszGameDescription2 = new(pszGameDescription)) {
        ...
        public static void SetModDir(string pszModDir) {
            ...
            using (InteropHelp.UTF8StringHandle pszModDir2 = new(pszModDir)) {
        ...
        public static void LogOn(string pszToken) {
            ...
            using (InteropHelp.UTF8StringHandle pszToken2 = new(pszToken)) {
        ...
        public static void SetServerName(string pszServerName) {
            ...
            using (InteropHelp.UTF8StringHandle pszServerName2 = new(pszServerName)) {
        ...
        public static void SetMapName(string pszMapName) {
            ...
            using (InteropHelp.UTF8StringHandle pszMapName2 = new(pszMapName)) {
        ...
        public static void SetSpectatorServerName(string pszSpectatorServerName) {
            ...
            using (InteropHelp.UTF8StringHandle pszSpectatorServerName2 = new(pszSpectatorServerName)) {
        ...
        public static void SetGameTags(string pchGameTags) {
            ...
            using (InteropHelp.UTF8StringHandle pchGameTags2 = new(pchGameTags)) {
        ...
        public static void SetGameData(string pchGameData) {
            ...
            using (InteropHelp.UTF8StringHandle pchGameData2 = new(pchGameData)) {
        ...
        public static void SetRegion(string pszRegion) {
            ...
            using (InteropHelp.UTF8StringHandle pszRegion2 = new(pszRegion)) {
        ...
        public static bool BUpdateUserData(CSteamID steamIDUser, string pchPlayerName, uint uScore) {
            ...
            using (InteropHelp.UTF8StringHandle pchPlayerName2 = new(pchPlayerName)) {
