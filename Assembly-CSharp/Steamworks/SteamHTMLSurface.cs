...
namespace Steamworks {
    public static class SteamHTMLSurface {
        ...
        public static SteamAPICall_t CreateBrowser(string pchUserAgent, string pchUserCSS) {
            ...
            using (InteropHelp.UTF8StringHandle pchUserAgent2 = new(pchUserAgent)) {
                using (InteropHelp.UTF8StringHandle pchUserCSS2 = new(pchUserCSS)) {
        ...
        public static void LoadURL(HHTMLBrowser unBrowserHandle, string pchURL, string pchPostData) {
            ...
            using (InteropHelp.UTF8StringHandle pchURL2 = new(pchURL)) {
                using (InteropHelp.UTF8StringHandle pchPostData2 = new(pchPostData)) {
        ...
        public static void ExecuteJavascript(HHTMLBrowser unBrowserHandle, string pchScript) {
            ...
            using (InteropHelp.UTF8StringHandle pchScript2 = new(pchScript)) {
        ...
        public static void Find(HHTMLBrowser unBrowserHandle, string pchSearchStr, bool bCurrentlyInFind, bool bReverse) {
            ...
            using (InteropHelp.UTF8StringHandle pchSearchStr2 = new(pchSearchStr)) {
        ...
        public static void SetCookie(string pchHostname, string pchKey, string pchValue, string pchPath = "/", uint nExpires = 0u, bool bSecure = false, bool bHTTPOnly = false) {
            ...
            using (InteropHelp.UTF8StringHandle pchHostname2 = new(pchHostname)) {
                using (InteropHelp.UTF8StringHandle pchKey2 = new(pchKey)) {
                    using (InteropHelp.UTF8StringHandle pchValue2 = new(pchValue)) {
                        using (InteropHelp.UTF8StringHandle pchPath2 = new(pchPath)) {
