...
namespace Steamworks {
    public static class SteamFriends {
        ...
        public static SteamAPICall_t SetPersonaName(string pchPersonaName) {
            ...
            using (InteropHelp.UTF8StringHandle pchPersonaName2 = new(pchPersonaName)) {
        ...
        public static void ActivateGameOverlay(string pchDialog) {
            ...
            using (InteropHelp.UTF8StringHandle pchDialog2 = new(pchDialog)) {
        ...
        public static bool InviteUserToGame(CSteamID steamIDFriend, string pchConnectString) {
            ...
            using (InteropHelp.UTF8StringHandle pchConnectString2 = new(pchConnectString)) {
        ...
        public static bool SendClanChatMessage(CSteamID steamIDClanChat, string pchText) {
            ...
            using (InteropHelp.UTF8StringHandle pchText2 = new(pchText)) {
                return NativeMethods.ISteamFriends_SendClanChatMessage(steamIDClanChat, pchText2);
            }
        }

        public static int GetClanChatMessage(CSteamID steamIDClanChat, int iMessage, out string prgchText, int cchTextMax, out EChatEntryType peChatEntryType,
        ...
        public static bool ReplyToFriendMessage(CSteamID steamIDFriend, string pchMsgToSend) {
            ...
            using (InteropHelp.UTF8StringHandle pchMsgToSend2 = new(pchMsgToSend)) {
