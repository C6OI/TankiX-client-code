...
namespace Steamworks {
    public static class SteamGameServerUGC {
        public static UGCQueryHandle_t CreateQueryUserUGCRequest(AccountID_t unAccountID, EUserUGCList eListType, EUGCMatchingUGCType eMatchingUGCType, EUserUGCListSortOrder eSortOrder,
            AppId_t nCreatorAppID, AppId_t nConsumerAppID, uint unPage) {
            InteropHelp.TestIfAvailableGameServer();

            return (UGCQueryHandle_t)NativeMethods.ISteamGameServerUGC_CreateQueryUserUGCRequest(unAccountID, eListType, eMatchingUGCType, eSortOrder, nCreatorAppID, nConsumerAppID,
                unPage);
        }

        public static UGCQueryHandle_t CreateQueryAllUGCRequest(EUGCQuery eQueryType, EUGCMatchingUGCType eMatchingeMatchingUGCTypeFileType, AppId_t nCreatorAppID, AppId_t nConsumerAppID,
            uint unPage) {
            InteropHelp.TestIfAvailableGameServer();
        ...
        public static bool GetQueryUGCAdditionalPreview(UGCQueryHandle_t handle, uint index, uint previewIndex, out string pchURLOrVideoID, uint cchURLSize,
            out string pchOriginalFileName, uint cchOriginalFileNameSize, out EItemPreviewType pPreviewType) {
            InteropHelp.TestIfAvailableGameServer();
            IntPtr intPtr = Marshal.AllocHGlobal((int)cchURLSize);
            IntPtr intPtr2 = Marshal.AllocHGlobal((int)cchOriginalFileNameSize);

            bool flag =
                NativeMethods.ISteamGameServerUGC_GetQueryUGCAdditionalPreview(handle, index, previewIndex, intPtr, cchURLSize, intPtr2, cchOriginalFileNameSize, out pPreviewType);
        ...
        public static bool AddRequiredTag(UGCQueryHandle_t handle, string pTagName) {
            ...
            using (InteropHelp.UTF8StringHandle pTagName2 = new(pTagName)) {
        ...
        public static bool SetLanguage(UGCQueryHandle_t handle, string pchLanguage) {
            ...
            using (InteropHelp.UTF8StringHandle pchLanguage2 = new(pchLanguage)) {
        ...
        public static bool SetCloudFileNameFilter(UGCQueryHandle_t handle, string pMatchCloudFileName) {
            ...
            using (InteropHelp.UTF8StringHandle pMatchCloudFileName2 = new(pMatchCloudFileName)) {
        ...
        public static bool SetSearchText(UGCQueryHandle_t handle, string pSearchText) {
            ...
            using (InteropHelp.UTF8StringHandle pSearchText2 = new(pSearchText)) {
        ...
        public static bool AddRequiredKeyValueTag(UGCQueryHandle_t handle, string pKey, string pValue) {
            ...
            using (InteropHelp.UTF8StringHandle pKey2 = new(pKey)) {
                using (InteropHelp.UTF8StringHandle pValue2 = new(pValue)) {
        ...
        public static bool SetItemMetadata(UGCUpdateHandle_t handle, string pchMetaData) {
            ...
            using (InteropHelp.UTF8StringHandle pchMetaData2 = new(pchMetaData)) {
        ...
        public static bool SetItemContent(UGCUpdateHandle_t handle, string pszContentFolder) {
            ...
            using (InteropHelp.UTF8StringHandle pszContentFolder2 = new(pszContentFolder)) {
        ...
        public static bool SetItemPreview(UGCUpdateHandle_t handle, string pszPreviewFile) {
            ...
            using (InteropHelp.UTF8StringHandle pszPreviewFile2 = new(pszPreviewFile)) {
        ...
        public static bool RemoveItemKeyValueTags(UGCUpdateHandle_t handle, string pchKey) {
            ...
            using (InteropHelp.UTF8StringHandle pchKey2 = new(pchKey)) {
        ...
        public static bool AddItemKeyValueTag(UGCUpdateHandle_t handle, string pchKey, string pchValue) {
            ...
            using (InteropHelp.UTF8StringHandle pchKey2 = new(pchKey)) {
                using (InteropHelp.UTF8StringHandle pchValue2 = new(pchValue)) {
        ...
        public static bool AddItemPreviewVideo(UGCUpdateHandle_t handle, string pszVideoID) {
            ...
            using (InteropHelp.UTF8StringHandle pszVideoID2 = new(pszVideoID)) {
        ...
        public static SteamAPICall_t SubmitItemUpdate(UGCUpdateHandle_t handle, string pchChangeNote) {
            ...
            using (InteropHelp.UTF8StringHandle pchChangeNote2 = new(pchChangeNote)) {
        ...
        public static bool BInitWorkshopForGameServer(DepotId_t unWorkshopDepotID, string pszFolder) {
            ...
            using (InteropHelp.UTF8StringHandle pszFolder2 = new(pszFolder)) {
