...
namespace Steamworks {
    ...
    public class gameserveritem_t {
        ...
        public string GetGameDir() => Encoding.UTF8.GetString(m_szGameDir, 0, Array.IndexOf(m_szGameDir, (byte)0));

        public void SetGameDir(string dir) {
            m_szGameDir = Encoding.UTF8.GetBytes(dir + '\0');
        }

        public string GetMap() => Encoding.UTF8.GetString(m_szMap, 0, Array.IndexOf(m_szMap, (byte)0));

        public void SetMap(string map) {
            m_szMap = Encoding.UTF8.GetBytes(map + '\0');
        }

        public string GetGameDescription() => Encoding.UTF8.GetString(m_szGameDescription, 0, Array.IndexOf(m_szGameDescription, (byte)0));
        ...
        public string GetGameTags() => Encoding.UTF8.GetString(m_szGameTags, 0, Array.IndexOf(m_szGameTags, (byte)0));
