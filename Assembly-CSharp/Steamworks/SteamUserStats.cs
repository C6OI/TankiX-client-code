...
namespace Steamworks {
    public static class SteamUserStats {
        ...
        public static bool GetStat(string pchName, out int pData) {
            ...
            using (InteropHelp.UTF8StringHandle pchName2 = new(pchName)) {
        ...
        public static SteamAPICall_t FindOrCreateLeaderboard(string pchLeaderboardName, ELeaderboardSortMethod eLeaderboardSortMethod, ELeaderboardDisplayType eLeaderboardDisplayType) {
            ...
            using (InteropHelp.UTF8StringHandle pchLeaderboardName2 = new(pchLeaderboardName)) {
        ...
        public static bool GetDownloadedLeaderboardEntry(SteamLeaderboardEntries_t hSteamLeaderboardEntries, int index, out LeaderboardEntry_t pLeaderboardEntry, int[] pDetails,
            int cDetailsMax) {
            InteropHelp.TestIfAvailableClient();
        ...
        public static SteamAPICall_t UploadLeaderboardScore(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardUploadScoreMethod eLeaderboardUploadScoreMethod, int nScore,
            int[] pScoreDetails, int cScoreDetailsCount) {
            InteropHelp.TestIfAvailableClient();
        ...
        public static bool GetGlobalStat(string pchStatName, out long pData) {
            ...
            using (InteropHelp.UTF8StringHandle pchStatName2 = new(pchStatName)) {
