...
namespace MIConvexHull {
    public static class ConvexHull {
        public static ConvexHull<TVertex, TFace>
            Create<TVertex, TFace>(IList<TVertex> data, ConvexHullComputationConfig config = null)
        ...
        public static ConvexHull<TVertex, DefaultConvexFace<TVertex>> Create<TVertex>(IList<TVertex> data,
            ConvexHullComputationConfig config = null) where TVertex : IVertex =>
        ...
        public static ConvexHull<DefaultVertex, DefaultConvexFace<DefaultVertex>> Create(IList<double[]> data,
            ...
            List<DefaultVertex> data2 = data.Select(p => new DefaultVertex {
                Position = p.ToArray()
            }).ToList();
