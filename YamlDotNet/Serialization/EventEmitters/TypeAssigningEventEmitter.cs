...
namespace YamlDotNet.Serialization.EventEmitters {
    public sealed class TypeAssigningEventEmitter : ChainedEventEmitter {
        readonly bool _assignTypeWhenDifferent;

        public TypeAssigningEventEmitter(IEventEmitter nextEmitter, bool assignTypeWhenDifferent)
            : base(nextEmitter) => _assignTypeWhenDifferent = assignTypeWhenDifferent;
        ...
        void AssignTypeIfDifferent(ObjectEventInfo eventInfo) {
            if (_assignTypeWhenDifferent &&
                eventInfo.Source.Value != null &&
