...
namespace YamlDotNet.Serialization.EventEmitters {
    public sealed class WriterEventEmitter : IEventEmitter {
        ...
        public WriterEventEmitter(IEmitter emitter) => this.emitter = emitter;

        void IEventEmitter.Emit(AliasEventInfo eventInfo) => emitter.Emit(new AnchorAlias(eventInfo.Alias));

        void IEventEmitter.Emit(ScalarEventInfo eventInfo) => emitter.Emit(new Scalar(eventInfo.Anchor,
            eventInfo.Tag,
        ...
        void IEventEmitter.Emit(MappingEndEventInfo eventInfo) => emitter.Emit(new MappingEnd());
        ...
        void IEventEmitter.Emit(SequenceEndEventInfo eventInfo) => emitter.Emit(new SequenceEnd());
    }
}