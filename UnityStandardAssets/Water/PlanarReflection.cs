...
namespace UnityStandardAssets.Water {
    ...
    public class PlanarReflection : MonoBehaviour {
        ...
        public void Start() => m_SharedMaterial = ((WaterBase)gameObject.GetComponent(typeof(WaterBase))).sharedMaterial;
        ...
        Camera CreateReflectionCameraFor(Camera cam) {
            string text = this.gameObject.name + "Reflection" + cam.name;
        ...
        RenderTexture CreateTextureFor(Camera cam) {
            RenderTexture renderTexture = new(Mathf.FloorToInt(cam.pixelWidth * 0.5f),
