...
namespace UnityStandardAssets.ImageEffects {
    class Quads {
        ...
        public static Mesh[] GetMeshes(int totalWidth, int totalHeight) {
            ...
            int num3 = Mathf.CeilToInt(1f * num2 / (1f * num));
        ...
        static Mesh GetMesh(int triCount, int triOffset, int totalWidth, int totalHeight) {
            ...
            for (int i = 0; i < triCount; i++) {
                ...
                float num4 = Mathf.Floor(num3 % totalWidth) / totalWidth;
                float num5 = Mathf.Floor(num3 / totalWidth) / totalHeight;
                Vector3 vector = new(num4 * 2f - 1f, num5 * 2f - 1f, 1f);
                array[num] = vector;
                array[num + 1] = vector;
                array[num + 2] = vector;
                array[num + 3] = vector;
