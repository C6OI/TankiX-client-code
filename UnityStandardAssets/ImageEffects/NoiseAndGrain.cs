        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination) {
            ...
            if (dx11Grain && supportDX11) {
                ...
                if (softness > Mathf.Epsilon) {
                    RenderTexture temporary = RenderTexture.GetTemporary((int)(source.width * (1f - softness)),
                        (int)(source.height * (1f - softness)));
            ...
            if (softness > Mathf.Epsilon) {
                RenderTexture temporary2 = RenderTexture.GetTemporary((int)(source.width * (1f - softness)),
                    (int)(source.height * (1f - softness)));
