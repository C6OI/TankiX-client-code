...
namespace Lobby.ClientSettings.API {
    public class CompactScreenBehaviour : MonoBehaviour {
        ...
        void OnApplicationQuit() => GraphicsSettings.INSTANCE.SaveWindowModeOnQuit();
        ...
        public void InitCompactMode() {
            ...
            avgRes = GraphicsSettings.INSTANCE.ScreenResolutions
                .OrderBy(r => Mathf.Abs(r.width - avgWidth) + Mathf.Abs(r.height - avgHeight)).First();
        ...
        void ApplyCompactScreenData() => Screen.SetResolution(avgRes.width, avgRes.height, false);

        void ApplyInitialScreenData() => GraphicsSettings.INSTANCE.ApplyInitialScreenResolutionData();
