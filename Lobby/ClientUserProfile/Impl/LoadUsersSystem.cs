...
namespace Lobby.ClientUserProfile.Impl {
    public class LoadUsersSystem : ECSSystem {
        ...
        [OnEventFire]
        public void LoadUser(NodeAddedEvent e, SingleNode<LoadUserComponent> loadUser,
            [JoinAll] SingleNode<SharedUsersStorageComponent> storage,
        ...
        [OnEventFire]
        public void LoadUsers(NodeAddedEvent e, SingleNode<LoadUsersComponent> loadUsers,
            [JoinAll] SingleNode<SharedUsersStorageComponent> storage,
            [JoinByUser] SingleNode<ClientSessionComponent> session) {
        ...
        [OnEventFire]
        public void UnLoadUsers(NodeRemoveEvent e, SingleNode<LoadUsersComponent> loadUsers,
            [JoinAll] SingleNode<SharedUsersStorageComponent> storage,
            [JoinAll] SingleNode<ClientSessionComponent> session) {
            HashSet<long> hashSet = new();
