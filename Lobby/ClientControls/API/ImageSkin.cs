...
namespace Lobby.ClientControls.API {
    ...
    public class ImageSkin : MonoBehaviour, SpriteRequest {
        ...
        protected void Reset() => ResetSkin();

        protected virtual void OnEnable() => RegisterRequest();
        ...
        protected void OnBeforeTransformParentChanged() => CancelRequest();

        protected void OnTransformParentChanged() => RegisterRequest();
        ...
        void RegisterRequest() {
            if (!string.IsNullOrEmpty(spriteUid)) {
                ...
                BaseElementScaleControllerProvider componentInParent =
                    GetComponentInParent<BaseElementScaleControllerProvider>();
        ...
        void CancelRequest() {
            if (requestRegistered) {
                ...
                if (componentInParent != null) {
                    componentInParent.BaseElementScaleController.UnregisterSpriteRequest(this);
                    requestRegistered = false;
                }
            }
        }

        public void ResetSkin() => Image.sprite = null;
    }
}