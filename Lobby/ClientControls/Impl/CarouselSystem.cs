...
namespace Lobby.ClientControls.Impl {
    public class CarouselSystem : ECSSystem {
        ...
        [OnEventFire]
        public void UpdateCarouselText(NodeAddedEvent e, CarouselCurrentItemNode item,
            [JoinByCarousel] ReadyCarouselNode carousel) =>
            carousel.carousel.Text.text = item.carouselItemText.LocalizedCaption;

        [OnEventFire]
        public void SwitchCarouselItem(CarouselItemBeforeChangeEvent evt, ReadyCarouselNode carousel, CarouselItemNode item,
            [JoinByCarousel] CarouselCurrentItemNode currentItem) {
        ...
        [OnEventFire]
        public void ClickFront(ButtonClickEvent e, SingleNode<CarouselFrontButtonComponent> btn,
            [JoinByCarousel] ReadyCarouselNode carousel) => MoveCarousel(carousel, 1);

        [OnEventFire]
        public void ClickBack(ButtonClickEvent e, SingleNode<CarouselBackButtonComponent> btn,
            [JoinByCarousel] ReadyCarouselNode carousel) => MoveCarousel(carousel, -1);
        ...
        void MoveCarousel(ReadyCarouselNode carousel, int dir) {
            List<Entity> items = carousel.carouselItemCollection.Items;
