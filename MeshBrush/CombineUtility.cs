...
namespace MeshBrush {
    public class CombineUtility {
        ...
        static int triangleOffset;

        static int stripOffset;
        ...
        public static Mesh Combine(MeshInstance[] combines, bool generateStrips) {
            ...
            for (int k = 0; k < combines.Length; k++) {
                ...
                if ((bool)meshInstance3.mesh) {
                    Copy(meshInstance3.mesh.vertexCount,
                        meshInstance3.mesh.vertices,
                        vertices,
                        ref offset,
                        meshInstance3.transform);
                }
            }
            ...
            for (int l = 0; l < combines.Length; l++) {
                ...
                if ((bool)meshInstance4.mesh) {
                    ...
                    CopyNormal(meshInstance4.mesh.vertexCount,
                        meshInstance4.mesh.normals,
                        normals,
                        ref offset,
                        invTranspose);
                }
            ...
            for (int m = 0; m < combines.Length; m++) {
                ...
                if ((bool)meshInstance5.mesh) {
                    ...
                    CopyTangents(meshInstance5.mesh.vertexCount,
                        meshInstance5.mesh.tangents,
                        tangents,
                        ref offset,
                        invTranspose);
                }
