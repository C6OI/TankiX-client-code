namespace SharpCompress.Compressor.LZMA {
    abstract class Base {
        ...
        public struct State {
            ...
            public void UpdateMatch() => Index = Index >= 7 ? 10u : 7u;

            public void UpdateRep() => Index = Index >= 7 ? 11u : 8u;

            public void UpdateShortRep() => Index = Index >= 7 ? 11u : 9u;
