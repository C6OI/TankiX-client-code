...
namespace SharpCompress.Compressor.BZip2 {
    class CBZip2OutputStream : Stream {
        ...
        readonly int[] mtfFreq = new int[258];
        ...
        protected static void HbMakeCodeLengths(char[] len, int[] freq, int alphaSize, int maxLen) {
            ...
            while (true) {
                ...
                while (num2 > 1) {
                    ...
                    array2[num] = (int)((array2[num5] & 0xFFFFFF00u) + (array2[num9] & 0xFFFFFF00u)) |
                                  1 +
                                  ((array2[num5] & 0xFF) <= (array2[num9] & 0xFF) ? array2[num9] & 0xFF
                                       : array2[num5] & 0xFF);
        ...
        void MainSort() {
            ...
            do {
                ...
                for (int i = num5; i <= 255; i++) {
                    ...
                    while (ftab[array[num4 - num5] + 1 << 8] - ftab[array[num4 - num5] << 8] >
                           ftab[num6 + 1 << 8] - ftab[num6 << 8]) {
