...
namespace SharpCompress.Compressor.BZip2 {
    class CBZip2InputStream : Stream {
        ...
        static void BadBGLengths() => Cadvise();

        static void BitStreamEOF() => Cadvise();

        static void CompressedStreamEOF() => Cadvise();
        ...
        static void BlockOverrun() => Cadvise();

        static void BadBlockHeader() => Cadvise();

        static void CrcError() => Cadvise();
        ...
        void HbCreateDecodeTables(int[] limit, int[] basev, int[] perm, char[] length, int minLen, int maxLen,
            int alphaSize) {
            int num = 0;
