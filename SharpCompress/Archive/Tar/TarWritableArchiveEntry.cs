...
namespace SharpCompress.Archive.Tar {
    class TarWritableArchiveEntry : TarArchiveEntry {
        readonly bool closeStream;

        internal TarWritableArchiveEntry(TarArchive archive, Stream stream, CompressionType compressionType, string path,
            long size, DateTime? lastModified, bool closeStream)
