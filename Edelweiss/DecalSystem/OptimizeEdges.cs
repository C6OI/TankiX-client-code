...
namespace Edelweiss.DecalSystem {
    class OptimizeEdges {
        ...
        public void Clear() => m_EdgeDictionary.Clear();

        public bool HasEdge(OptimizeEdge a_OptimizeEdge) => m_EdgeDictionary.ContainsKey(a_OptimizeEdge);

        public void AddEdge(OptimizeEdge a_OptimizeEdge) => m_EdgeDictionary.Add(a_OptimizeEdge, a_OptimizeEdge);

        public void RemoveEdge(OptimizeEdge a_OptimizeEdge) => m_EdgeDictionary.Remove(a_OptimizeEdge);
