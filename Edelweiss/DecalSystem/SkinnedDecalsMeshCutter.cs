...
namespace Edelweiss.DecalSystem {
    public class SkinnedDecalsMeshCutter : GenericDecalsMeshCutter<SkinnedDecals, SkinnedDecalProjectorBase,
        SkinnedDecalsMesh> {
        readonly BoneWeightElement[] m_BoneWeightElements = new BoneWeightElement[8];
        ...
        BoneWeight LerpBoneWeights(BoneWeight a_BoneWeight1, BoneWeight a_BoneWeight2, float a_Factor) {
            BoneWeightElement boneWeightElement = default;
            ...
            float num2 = 1f /
                         (m_BoneWeightElements[0].weight +
                          m_BoneWeightElements[1].weight +
                          m_BoneWeightElements[2].weight +
                          m_BoneWeightElements[3].weight);
