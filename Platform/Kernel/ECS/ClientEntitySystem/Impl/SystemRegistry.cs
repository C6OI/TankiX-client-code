...
namespace Platform.Kernel.ECS.ClientEntitySystem.Impl {
    public class SystemRegistry {
        ...
        public void ForceRegisterSystem(ECSSystem system) => DoRegister(system);
        ...
        void InitSystem(ECSSystem systemInstance) => systemInstance.Init(templateRegistry,
            engineService.DelayedEventManager,
            engineService,
            nodeRegistrator);
