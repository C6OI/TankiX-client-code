...
namespace Platform.Kernel.ECS.ClientEntitySystem.Impl {
    public class GroupRegistryImpl : GroupRegistry {
        readonly IDictionary<Type, IDictionary<long, GroupComponent>> groups =
            new Dictionary<Type, IDictionary<long, GroupComponent>>();
        ...
        public T FindOrRegisterGroup<T>(T groupComponent) where T : GroupComponent =>
            (T)FindOrRegisterGroup((GroupComponent)groupComponent);
