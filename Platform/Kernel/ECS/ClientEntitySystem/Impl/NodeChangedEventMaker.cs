...
namespace Platform.Kernel.ECS.ClientEntitySystem.Impl {
    public class NodeChangedEventMaker {
        ...
        public NodeChangedEventMaker(Event eventInstance, Type fireHandlerType, Type completeHandlerType,
        ...
        public void MakeIfNeed(Entity entity, Type componentType) {
            ICollection<NodeDescription> nodeDescriptions =
                ((EntityInternal)entity).NodeDescriptionStorage.GetNodeDescriptions(componentType);
        ...
        void Make(Entity entity, ICollection<NodeDescription> changedNodes) {
            if (changedNodes.Count != 0) {
                ...
                ICollection<Handler> completeHandlers =
                    CollectHandlers(handlerCollector, _completeHandlerType, changedNodes);

                Flow.Current.TryInvoke(fireHandlers, completeHandlers, eventInstance, entity, changedNodes);
            }
        }

        public static ICollection<Handler> CollectHandlers(HandlerCollector handlerCollector, Type handlerType,
