...
namespace Platform.Kernel.ECS.ClientEntitySystem.Impl {
    public class NodeProvider {
        ...
        public void OnComponentAdded(Component component) => UpdateComponentValue(component, component.GetType());

        public void OnComponentAdded(Component component, Type componentType) =>
            UpdateComponentValue(component, componentType);

        public void OnComponentChanged(Component component) => UpdateComponentValue(component, component.GetType());

        void UpdateComponentValue(Component component, Type componentType) {
            ICollection<NodeClassInstanceDescription> classInstanceDescriptionByComponent =
                NodeDescriptionRegistry.GetClassInstanceDescriptionByComponent(componentType);
