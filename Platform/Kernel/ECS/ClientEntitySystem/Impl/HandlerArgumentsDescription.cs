...
namespace Platform.Kernel.ECS.ClientEntitySystem.Impl {
    public class HandlerArgumentsDescription {
        public HandlerArgumentsDescription(IList<HandlerArgument> handlerArguments, ICollection<Type> additionalEventClasses,
            ICollection<Type> additionalComponentClasses) {
