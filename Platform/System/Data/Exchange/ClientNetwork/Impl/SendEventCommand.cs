...
namespace Platform.System.Data.Exchange.ClientNetwork.Impl {
    public class SendEventCommand : AbstractCommand {
        ...
        [ProtocolParameterOrder(0)] [ProtocolVaried]
        public Event E { get; set; }

        [ProtocolParameterOrder(1)] public Entity[] Entities { get; set; }

        public override void Execute(Engine engine) => Flow.Current.SendEventWithoutInternal(E, Entities);
        ...
        public override int GetHashCode() =>
            (E != null ? E.GetHashCode() : 0) * 397 ^ (Entities != null ? CalculateHashCode() : 0);
        ...
        public override string ToString() =>
            string.Format("SendEventCommand: Event={0} Entities={1}", E, EcsToStringUtil.ToString(Entities));
    }
}