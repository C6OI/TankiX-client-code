...
namespace Platform.Library.ClientProtocol.Impl {
    public class BigEndianBinaryWriter : BinaryWriter {
        ...
        void ReverseIfNeedAndWrite(byte[] bytes) {
        ...
        public override void Write(double value) => ReverseIfNeedAndWrite(BitConverter.GetBytes(value));

        public override void Write(float value) => ReverseIfNeedAndWrite(BitConverter.GetBytes(value));
