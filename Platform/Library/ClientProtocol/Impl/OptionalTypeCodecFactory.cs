...
namespace Platform.Library.ClientProtocol.Impl {
    public class OptionalTypeCodecFactory : CodecFactory {
        ...
        public OptionalTypeCodecFactory() => enumCodec = new EnumCodec();
        ...
        public Codec CreateCodec(Protocol protocol, CodecInfoWithAttributes codecInfoWithAttrs) {
            ...
            if (type.IsGenericType && type.GetGenericTypeDefinition() == typeof(Optional<>)) {
                ...
                return new OptionalTypeCodec(type,
                    new CodecInfoWithAttributes(type2, false, codecInfoWithAttrs.Info.varied));
            }
