...
namespace Platform.Library.ClientProtocol.Impl {
    public class ProtocolImpl : Protocol {
        ...
        public void RegisterCodecForType<T>(Codec codec) => RegisterCodecForType(typeof(T), codec);
        ...
        public void WrapPacket(ProtocolBuffer source, StreamData dest) => PacketHelper.WrapPacket(source, dest);
        ...
        Codec CreateCodecIfNecessary(CodecInfoWithAttributes codecInfoWithAttributes) {
            ...
            for (Type baseType = info.type.BaseType; baseType != null; baseType = baseType.BaseType) {
                CodecInfo key = new(baseType, info.optional, info.varied);
        ...
        protected virtual void RegisterFactory(CodecFactory factory) => factories.Add(factory);
