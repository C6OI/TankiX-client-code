...
namespace Platform.Library.ClientResources.API {
    ...
    public class AssetReference {
        ...
        public global::System.Action<Object> OnLoaded;
        ...
        public void Load(int priority) => ClientUnityIntegrationUtils.ExecuteInFlow(delegate(Engine engine) {
            Entity entity = engine.CreateEntity("Load " + assetGuid);
