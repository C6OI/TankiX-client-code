...
namespace Platform.Library.ClientResources.Impl {
    ...
    public class AssetBundleInfo {
        ...
        internal void AddAssetInfo(AssetInfo assetInfo) => Assets.Add(assetInfo);
        ...
        public override string ToString() =>
            string.Format("[AssetBundleInfo: bundleName={0}, hash={1}, size={2}, dependenciesNames={3}, assets={4}]",
                bundleName,
                hash,
                size,
                dependenciesNames,
        ...
        public override bool Equals(object obj) {
            ...
            return HashString == assetBundleInfo.HashString && assetBundleInfo.BundleName == BundleName;
        }
    }
}