...
namespace Platform.Library.ClientResources.Impl {
    public class LocalConfigurationActivator : UnityAwareActivator<ManuallyCompleting> {
        ...
        protected override void Activate() => LoadConfigs();
        ...
        void LoadConfigs() {
            ...
            try {
                ...
                ConfigTreeNodeImpl rootConfigNode =
                    fileSystemConfigsImporter.Import<ConfigTreeNodeImpl>(text, configurationProfile);
        ...
        void HandleError() => ClientUnityIntegrationUtils.ExecuteInFlow(delegate(Engine engine) {
