...
namespace Platform.Library.ClientResources.Impl {
    public static class AssetTypeRegistry {
        ...
        static void RegisterAssetType<T>() => RegisterAssetType(typeof(T));

        static void RegisterAssetType(Type type) => hash2Type.Add(GetTypeHash(type), type);

        static void RegisterTypeExtension<T>(string extension) => extension2Type.Add(extension.ToLower(), typeof(T));
