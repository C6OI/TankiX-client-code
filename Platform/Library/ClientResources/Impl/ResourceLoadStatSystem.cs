...
namespace Platform.Library.ClientResources.Impl {
    public class ResourceLoadStatSystem : ECSSystem {
        ...
        [OnEventFire]
        public void UpdateLoadProgress(UpdateEvent e, LoadingChannelNode loaderNode,
            [JoinBy(typeof(ResourceGroupComponent))] LoadStatNode resource) {
            ...
            if (!(Mathf.Abs(num2 - num) < 0.001f)) {
                ...
                resourceLoadStat.Progress =
                    resourceLoadStat.BytesTotal != 0 ? Mathf.Clamp01(num3 / resourceLoadStat.BytesTotal) : 1f;
